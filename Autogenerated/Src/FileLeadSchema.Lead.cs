namespace Terrasoft.Configuration
{
	...
	public class FileLead_Lead_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFileLead_Lead_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFileLead_Lead_TerrasoftEventsProcessSchema() {
			var schema = new FileLead_Lead_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: FileLead_Lead_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class FileLead_Lead_TerrasoftEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public FileLead_Lead_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FileLead_Lead_TerrasoftEventsProcessSchema(FileLead_Lead_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FileLead_LeadEventsProcess";
			UId = new Guid("d25ab07d-0c9a-4a0f-9133-31657e1281bb");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new FileLead_Lead_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("d25ab07d-0c9a-4a0f-9133-31657e1281bb"));
		}
