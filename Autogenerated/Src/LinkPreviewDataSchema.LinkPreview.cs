namespace Terrasoft.Configuration
{
	...
	public class LinkPreviewDataSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLinkPreviewDataEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLinkPreviewDataEventsProcessSchema() {
			var schema = new LinkPreviewDataEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class LinkPreviewData_LinkPreviewEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : LinkPreviewData
	{
	...
	#region Class: LinkPreviewDataEventsProcessSchema

	/// <exclude/>
	public class LinkPreviewDataEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public LinkPreviewDataEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LinkPreviewDataEventsProcessSchema(LinkPreviewDataEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LinkPreviewData_LinkPreviewEventsProcess";
			UId = new Guid("f5bbc3fe-86cd-453a-b3ff-eae72caef9c9");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new LinkPreviewDataEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f5bbc3fe-86cd-453a-b3ff-eae72caef9c9"));
		}
