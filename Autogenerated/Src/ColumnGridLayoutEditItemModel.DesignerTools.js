define("ColumnGridLayoutEditItemModel", ["ModalBox", "GridLayoutEditItemModel"], function(ModalBox) {
	...
	Ext.define("Terrasoft.configuration.ColumnGridLayoutEditItemModel", {
		...
		openDesigner: function() {
			...
			const column = this.column || {};
			switch (true) {
				case Terrasoft.Features.getIsEnabled("DateTimeColumnPropertiesPage") &&
						column.dataValueType === Terrasoft.DataValueType.DATE_TIME:
		...
		_openDesignerNew: function() {
			...
			this.designSchema.sandbox.loadModule("DateTimeColumnPropertiesPageModule", {
				id: moduleId,
				renderTo: renderTo
			});
		},
