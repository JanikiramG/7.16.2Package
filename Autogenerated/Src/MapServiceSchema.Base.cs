namespace Terrasoft.Configuration
{
	...
	public class MapServiceSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMapServiceEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMapServiceEventsProcessSchema() {
			var schema = new MapServiceEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: MapServiceEventsProcessSchema

	/// <exclude/>
	public class MapServiceEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public MapServiceEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MapServiceEventsProcessSchema(MapServiceEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MapService_BaseEventsProcess";
			UId = new Guid("ed0347d3-440a-4e9c-93a6-64b580386923");
		...
		public override object Clone() {
			return new MapServiceEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ed0347d3-440a-4e9c-93a6-64b580386923"));
		}
