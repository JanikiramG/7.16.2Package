namespace Terrasoft.Configuration
{
	...
	public class OppContactRole_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOppContactRole_Opportunity_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOppContactRole_Opportunity_TerrasoftEventsProcessSchema() {
			var schema = new OppContactRole_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OppContactRole_Opportunity_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class OppContactRole_Opportunity_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public OppContactRole_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OppContactRole_Opportunity_TerrasoftEventsProcessSchema(OppContactRole_Opportunity_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OppContactRole_OpportunityEventsProcess";
			UId = new Guid("6ba6d594-0f89-4ebb-9e6c-55fa7f6791ce");
			CreatedInPackageId = new Guid("00444c93-d7ec-4107-babc-79df871f5d21");
		...
		public override object Clone() {
			return new OppContactRole_Opportunity_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("6ba6d594-0f89-4ebb-9e6c-55fa7f6791ce"));
		}
