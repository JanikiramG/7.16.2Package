namespace Terrasoft.Configuration
{
	...
	public class OrderTag_Order_TerrasoftSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrderTag_Order_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrderTag_Order_TerrasoftEventsProcessSchema() {
			var schema = new OrderTag_Order_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OrderTag_Order_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class OrderTag_Order_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public OrderTag_Order_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrderTag_Order_TerrasoftEventsProcessSchema(OrderTag_Order_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrderTag_OrderEventsProcess";
			UId = new Guid("57cb6402-a775-4f20-851f-7133c5d2d64d");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new OrderTag_Order_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("57cb6402-a775-4f20-851f-7133c5d2d64d"));
		}
