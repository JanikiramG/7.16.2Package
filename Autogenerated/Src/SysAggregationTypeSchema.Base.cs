namespace Terrasoft.Configuration
{
	...
	public class SysAggregationTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysAggregationTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysAggregationTypeEventsProcessSchema() {
			var schema = new SysAggregationTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysAggregationTypeEventsProcessSchema

	/// <exclude/>
	public class SysAggregationTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysAggregationTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysAggregationTypeEventsProcessSchema(SysAggregationTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysAggregationType_BaseEventsProcess";
			UId = new Guid("f6fde3ff-b5b8-4376-b1c8-727d90c7d8a4");
		...
		public override object Clone() {
			return new SysAggregationTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f6fde3ff-b5b8-4376-b1c8-727d90c7d8a4"));
		}
