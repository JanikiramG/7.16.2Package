namespace Terrasoft.Configuration
{
	...
	public class ConnectionTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateConnectionTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateConnectionTypeEventsProcessSchema() {
			var schema = new ConnectionTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ConnectionTypeEventsProcessSchema

	/// <exclude/>
	public class ConnectionTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ConnectionTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ConnectionTypeEventsProcessSchema(ConnectionTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ConnectionType_BaseEventsProcess";
			UId = new Guid("3e50e027-b3ed-46c1-8c1f-5a8ba21e2809");
			CreatedInPackageId = new Guid("76eace8e-4a48-486b-bf04-de18fe06b0a2");
		...
		public override object Clone() {
			return new ConnectionTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3e50e027-b3ed-46c1-8c1f-5a8ba21e2809"));
		}
