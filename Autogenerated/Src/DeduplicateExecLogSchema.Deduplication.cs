namespace Terrasoft.Configuration
{
	...
	public class DeduplicateExecLogSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDeduplicateExecLogEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDeduplicateExecLogEventsProcessSchema() {
			var schema = new DeduplicateExecLogEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DeduplicateExecLogEventsProcessSchema

	/// <exclude/>
	public class DeduplicateExecLogEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public DeduplicateExecLogEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DeduplicateExecLogEventsProcessSchema(DeduplicateExecLogEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DeduplicateExecLog_DeduplicationEventsProcess";
			UId = new Guid("a7becfac-edef-4e52-b4f8-6136e3ba15c2");
			CreatedInPackageId = new Guid("a2cb4b0a-72d7-4fbf-b57c-bc3bae7898e7");
		...
		public override object Clone() {
			return new DeduplicateExecLogEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a7becfac-edef-4e52-b4f8-6136e3ba15c2"));
		}
