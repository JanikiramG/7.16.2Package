namespace Terrasoft.Configuration
{
	...
	public class OppDepartmentForecastSchema : Terrasoft.Configuration.EntityInForecastCellSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOppDepartmentForecastEventsProcessSchema();
		}
	...
	#region Class: OppDepartmentForecastEventsProcessSchema

	/// <exclude/>
	public class OppDepartmentForecastEventsProcessSchema : Terrasoft.Configuration.EntityInForecastCellEventsProcessSchema
	{

		#region Constructors: Public

		public OppDepartmentForecastEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OppDepartmentForecast_CoreForecastEventsProcess";
			UId = new Guid("5fdb2ecc-3bcb-4496-ac8e-25cef4d20e80");
			CreatedInPackageId = new Guid("e0b9d996-6f7e-4520-a678-da960c79be39");
		...
		public override object Clone() {
			return new OppDepartmentForecastEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5fdb2ecc-3bcb-4496-ac8e-25cef4d20e80"));
		}
