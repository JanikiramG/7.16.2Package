namespace Terrasoft.Configuration
{
	...
	public class VwSysProcessFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSysProcessFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSysProcessFolderEventsProcessSchema() {
			var schema = new VwSysProcessFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSysProcessFolderEventsProcessSchema

	/// <exclude/>
	public class VwSysProcessFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public VwSysProcessFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSysProcessFolderEventsProcessSchema(VwSysProcessFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSysProcessFolder_BaseEventsProcess";
			UId = new Guid("a6a18253-4565-41dd-ab01-c22b4a7b80cc");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new VwSysProcessFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a6a18253-4565-41dd-ab01-c22b4a7b80cc"));
		}
