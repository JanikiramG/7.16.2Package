namespace Terrasoft.Configuration
{
	...
	public class SysLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysLookupEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysLookupEventsProcessSchema() {
			var schema = new SysLookupEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysLookupEventsProcessSchema

	/// <exclude/>
	public class SysLookupEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysLookupEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysLookupEventsProcessSchema(SysLookupEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysLookup_BaseEventsProcess";
			UId = new Guid("4106a43a-5015-47f6-9dd1-5e9b579a6e4a");
		...
		public override object Clone() {
			return new SysLookupEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4106a43a-5015-47f6-9dd1-5e9b579a6e4a"));
		}
