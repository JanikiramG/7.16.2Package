namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CTISearchResult_CTIBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : CTISearchResult
	{
