namespace Terrasoft.Configuration
{
	...
	public class SocialChannelTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSocialChannelTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSocialChannelTagEventsProcessSchema() {
			var schema = new SocialChannelTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SocialChannelTagEventsProcessSchema

	/// <exclude/>
	public class SocialChannelTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public SocialChannelTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SocialChannelTagEventsProcessSchema(SocialChannelTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SocialChannelTag_ESNEventsProcess";
			UId = new Guid("41a741d1-0225-487f-94f1-83e541b90a6c");
			CreatedInPackageId = new Guid("323cd82b-b42c-461b-a2e0-e7cefd565455");
		...
		public override object Clone() {
			return new SocialChannelTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("41a741d1-0225-487f-94f1-83e541b90a6c"));
		}
