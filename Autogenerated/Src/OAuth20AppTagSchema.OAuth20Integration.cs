namespace Terrasoft.Configuration
{
	...
	public class OAuth20AppTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOAuth20AppTagEventsProcessSchema();
		}
	...
	#region Class: OAuth20AppTagEventsProcessSchema

	/// <exclude/>
	public class OAuth20AppTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public OAuth20AppTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OAuth20AppTag_OAuth20IntegrationEventsProcess";
			UId = new Guid("2a6aafb6-7a5f-402c-a406-a9b58a4b9d6f");
			CreatedInPackageId = new Guid("69832cb9-4518-407d-8490-ad1baa6b0193");
		...
		public override object Clone() {
			return new OAuth20AppTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2a6aafb6-7a5f-402c-a406-a9b58a4b9d6f"));
		}
