namespace Terrasoft.Configuration
{
	...
	public class AccountAlternativeNameSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountAlternativeNameEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountAlternativeNameEventsProcessSchema() {
			var schema = new AccountAlternativeNameEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountAlternativeNameEventsProcessSchema

	/// <exclude/>
	public class AccountAlternativeNameEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public AccountAlternativeNameEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountAlternativeNameEventsProcessSchema(AccountAlternativeNameEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountAlternativeName_BaseEventsProcess";
			UId = new Guid("319ad653-b322-4813-ba75-0a653bcf8af8");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new AccountAlternativeNameEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("319ad653-b322-4813-ba75-0a653bcf8af8"));
		}
