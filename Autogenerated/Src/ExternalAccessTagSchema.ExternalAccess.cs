namespace Terrasoft.Configuration
{
	...
	public class ExternalAccessTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateExternalAccessTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateExternalAccessTagEventsProcessSchema() {
			var schema = new ExternalAccessTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ExternalAccessTagEventsProcessSchema

	/// <exclude/>
	public class ExternalAccessTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ExternalAccessTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ExternalAccessTagEventsProcessSchema(ExternalAccessTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ExternalAccessTag_ExternalAccessEventsProcess";
			UId = new Guid("b3de885d-aa59-4399-9970-2ae9395e198f");
			CreatedInPackageId = new Guid("386ac9f6-07c1-4d11-8d16-e4e9424ba4e8");
		...
		public override object Clone() {
			return new ExternalAccessTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b3de885d-aa59-4399-9970-2ae9395e198f"));
		}
