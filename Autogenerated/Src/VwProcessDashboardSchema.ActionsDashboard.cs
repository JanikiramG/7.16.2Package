namespace Terrasoft.Configuration
{
	...
	public class VwProcessDashboard_ActionsDashboard_TerrasoftSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema() {
			var schema = new VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema(VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwProcessDashboard_ActionsDashboardEventsProcess";
			UId = new Guid("4929fdeb-f5ef-44ad-a3b8-0f153cf4ff45");
			CreatedInPackageId = new Guid("2c9213ec-f319-46ab-8cbf-ebd1dc87fafa");
		...
		public override object Clone() {
			return new VwProcessDashboard_ActionsDashboard_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4929fdeb-f5ef-44ad-a3b8-0f153cf4ff45"));
		}
