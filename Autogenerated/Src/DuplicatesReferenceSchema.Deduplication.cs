namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DuplicatesReference_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : DuplicatesReference
	{
