namespace Terrasoft.Configuration
{
	...
	public class VwEntityObjectsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwEntityObjectsEventsProcessSchema();
		}
	...
	/// <exclude/>
	public partial class VwEntityObjects_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwEntityObjects
	{
	...
	#region Class: VwEntityObjectsEventsProcessSchema

	/// <exclude/>
	public class VwEntityObjectsEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public VwEntityObjectsEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwEntityObjects_BaseEventsProcess";
			UId = new Guid("dad0a6c7-7da6-499f-b141-efb7e6eb75f7");
			CreatedInPackageId = new Guid("76eace8e-4a48-486b-bf04-de18fe06b0a2");
		...
		public override object Clone() {
			return new VwEntityObjectsEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("dad0a6c7-7da6-499f-b141-efb7e6eb75f7"));
		}
