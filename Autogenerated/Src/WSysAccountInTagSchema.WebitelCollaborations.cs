namespace Terrasoft.Configuration
{
	...
	public class WSysAccountInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateWSysAccountInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateWSysAccountInTagEventsProcessSchema() {
			var schema = new WSysAccountInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: WSysAccountInTagEventsProcessSchema

	/// <exclude/>
	public class WSysAccountInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public WSysAccountInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public WSysAccountInTagEventsProcessSchema(WSysAccountInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "WSysAccountInTag_WebitelCollaborationsEventsProcess";
			UId = new Guid("93d6b805-8650-44d6-81d5-dcb1542d0e26");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new WSysAccountInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("93d6b805-8650-44d6-81d5-dcb1542d0e26"));
		}
