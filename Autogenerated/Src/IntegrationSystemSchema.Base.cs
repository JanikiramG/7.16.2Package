namespace Terrasoft.Configuration
{
	...
	public class IntegrationSystemSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateIntegrationSystemEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateIntegrationSystemEventsProcessSchema() {
			var schema = new IntegrationSystemEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: IntegrationSystemEventsProcessSchema

	/// <exclude/>
	public class IntegrationSystemEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public IntegrationSystemEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public IntegrationSystemEventsProcessSchema(IntegrationSystemEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "IntegrationSystem_BaseEventsProcess";
			UId = new Guid("362f6716-12c8-40bc-b9db-73a4926bcaac");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new IntegrationSystemEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("362f6716-12c8-40bc-b9db-73a4926bcaac"));
		}
