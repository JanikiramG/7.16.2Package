namespace Terrasoft.Configuration
{
	...
	public class DistributionTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDistributionTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDistributionTypeEventsProcessSchema() {
			var schema = new DistributionTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DistributionTypeEventsProcessSchema

	/// <exclude/>
	public class DistributionTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DistributionTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DistributionTypeEventsProcessSchema(DistributionTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DistributionType_BaseEventsProcess";
			UId = new Guid("455e5c2e-1acd-4031-b84e-c4c6a6bafa2a");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new DistributionTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("455e5c2e-1acd-4031-b84e-c4c6a6bafa2a"));
		}
