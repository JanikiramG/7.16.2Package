namespace Terrasoft.Configuration
{
	...
	public class LendingStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLendingStateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLendingStateEventsProcessSchema() {
			var schema = new LendingStateEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LendingStateEventsProcessSchema

	/// <exclude/>
	public class LendingStateEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public LendingStateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LendingStateEventsProcessSchema(LendingStateEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LendingState_WebFormEventsProcess";
			UId = new Guid("9bbb04f0-1ea1-413f-acd9-c0b84fe0897f");
			CreatedInPackageId = new Guid("2f566863-6a05-41ae-bb68-b647818b8f61");
		...
		public override object Clone() {
			return new LendingStateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9bbb04f0-1ea1-413f-acd9-c0b84fe0897f"));
		}
