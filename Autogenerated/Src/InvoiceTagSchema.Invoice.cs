namespace Terrasoft.Configuration
{
	...
	public class InvoiceTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateInvoiceTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateInvoiceTagEventsProcessSchema() {
			var schema = new InvoiceTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: InvoiceTagEventsProcessSchema

	/// <exclude/>
	public class InvoiceTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public InvoiceTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public InvoiceTagEventsProcessSchema(InvoiceTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "InvoiceTag_InvoiceEventsProcess";
			UId = new Guid("eedc500d-2a62-41fb-a80e-b31c4d632c7c");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new InvoiceTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("eedc500d-2a62-41fb-a80e-b31c4d632c7c"));
		}
