namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwEntityInProcess_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwEntityInProcess
	{
