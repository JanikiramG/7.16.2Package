namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
	...
	/// Contact folder.
	/// </summary>
	public class ContactFolder : Terrasoft.Configuration.BaseFolder
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("ContactFolderDeleting", e);
			Inserted += (s, e) => ThrowEvent("ContactFolderInserted", e);
			Inserting += (s, e) => ThrowEvent("ContactFolderInserting", e);
			Saved += (s, e) => ThrowEvent("ContactFolderSaved", e);
			Saving += (s, e) => ThrowEvent("ContactFolderSaving", e);
	...
	/// <exclude/>
	public partial class ContactFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_BaseEventsProcess<TEntity> where TEntity : ContactFolder
	{
	...
	/// <exclude/>
	public class ContactFolder_BaseEventsProcess : ContactFolder_BaseEventsProcess<ContactFolder>
	{
	...
	/// <exclude/>
	public class ContactFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactFolder_BaseEventsProcess";
			UId = new Guid("a2f8f84f-72b8-4e72-941a-6da5bfa0a452");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a2f8f84f-72b8-4e72-941a-6da5bfa0a452"));
		}
	...
	/// <exclude/>
	public class ContactFolderEventsProcess : ContactFolder_BaseEventsProcess
	{
