namespace Terrasoft.Configuration
{
	...
	public class ContractFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContractFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContractFileEventsProcessSchema() {
			var schema = new ContractFileEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContractFileEventsProcessSchema

	/// <exclude/>
	public class ContractFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ContractFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContractFileEventsProcessSchema(ContractFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContractFile_CoreContractsEventsProcess";
			UId = new Guid("05736d8a-8ea3-4822-b2f9-b34082e4dc0c");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ContractFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("05736d8a-8ea3-4822-b2f9-b34082e4dc0c"));
		}
