namespace Terrasoft.Configuration
{
	...
	public class BrandSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBrandEventsProcessSchema();
		}
	...
	#region Class: BrandEventsProcessSchema

	/// <exclude/>
	public class BrandEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public BrandEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Brand_BaseEventsProcess";
			UId = new Guid("fbde8e9a-3766-4130-891c-42b8fdae70a5");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new BrandEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fbde8e9a-3766-4130-891c-42b8fdae70a5"));
		}
