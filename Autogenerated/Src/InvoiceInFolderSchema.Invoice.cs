namespace Terrasoft.Configuration
{
	...
	public class InvoiceInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateInvoiceInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateInvoiceInFolderEventsProcessSchema() {
			var schema = new InvoiceInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: InvoiceInFolderEventsProcessSchema

	/// <exclude/>
	public class InvoiceInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public InvoiceInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public InvoiceInFolderEventsProcessSchema(InvoiceInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new InvoiceInFolderEventsProcessSchema(this);
		}
