namespace Terrasoft.Configuration
{
	...
	public class InvoiceInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateInvoiceInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateInvoiceInTagEventsProcessSchema() {
			var schema = new InvoiceInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: InvoiceInTagEventsProcessSchema

	/// <exclude/>
	public class InvoiceInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public InvoiceInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public InvoiceInTagEventsProcessSchema(InvoiceInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "InvoiceInTag_InvoiceEventsProcess";
			UId = new Guid("50f90b70-0aba-4c16-ad95-4b4e7fdaf112");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new InvoiceInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("50f90b70-0aba-4c16-ad95-4b4e7fdaf112"));
		}
