namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysModuleEntityForEdit_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwSysModuleEntityForEdit
	{
