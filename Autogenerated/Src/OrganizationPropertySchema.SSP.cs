namespace Terrasoft.Configuration
{
	...
	public class OrganizationPropertySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrganizationPropertyEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrganizationPropertyEventsProcessSchema() {
			var schema = new OrganizationPropertyEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class OrganizationProperty_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : OrganizationProperty
	{
	...
	#region Class: OrganizationPropertyEventsProcessSchema

	/// <exclude/>
	public class OrganizationPropertyEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public OrganizationPropertyEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrganizationPropertyEventsProcessSchema(OrganizationPropertyEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrganizationProperty_SSPEventsProcess";
			UId = new Guid("9e988e5c-08d9-4905-9748-5892da9e8d0b");
			CreatedInPackageId = new Guid("7cc31540-fa76-4c79-9b86-a6eabd8e662c");
		...
		public override object Clone() {
			return new OrganizationPropertyEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9e988e5c-08d9-4905-9748-5892da9e8d0b"));
		}
