namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwModuleHistory_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwModuleHistory
	{
