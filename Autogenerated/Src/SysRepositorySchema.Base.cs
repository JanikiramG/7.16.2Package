namespace Terrasoft.Configuration
{
	...
	public class SysRepositorySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysRepositoryEventsProcessSchema();
		}
	...
	/// <exclude/>
	public partial class SysRepository_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysRepository
	{
	...
	#region Class: SysRepositoryEventsProcessSchema

	/// <exclude/>
	public class SysRepositoryEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysRepositoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysRepository_BaseEventsProcess";
			UId = new Guid("aaa07b47-cef2-4abe-afb5-77e07be1de6d");
			CreatedInPackageId = new Guid("c0d667fc-f22f-4d2e-8f98-6d81fc470df4");
		...
		public override object Clone() {
			return new SysRepositoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("aaa07b47-cef2-4abe-afb5-77e07be1de6d"));
		}
