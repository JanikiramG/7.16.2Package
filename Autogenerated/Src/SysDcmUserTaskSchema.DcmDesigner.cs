namespace Terrasoft.Configuration
{
	...
	public class SysDcmUserTaskSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysDcmUserTaskEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysDcmUserTaskEventsProcessSchema() {
			var schema = new SysDcmUserTaskEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysDcmUserTask_DcmDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysDcmUserTask
	{
	...
	#region Class: SysDcmUserTaskEventsProcessSchema

	/// <exclude/>
	public class SysDcmUserTaskEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysDcmUserTaskEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysDcmUserTaskEventsProcessSchema(SysDcmUserTaskEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysDcmUserTask_DcmDesignerEventsProcess";
			UId = new Guid("886e40eb-6728-48d5-9300-732f8d06bb8c");
			CreatedInPackageId = new Guid("c9089cd6-c7fc-4c89-ae0d-da891132232d");
		...
		public override object Clone() {
			return new SysDcmUserTaskEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("886e40eb-6728-48d5-9300-732f8d06bb8c"));
		}
