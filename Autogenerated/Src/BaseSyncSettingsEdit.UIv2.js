define("BaseSyncSettingsEdit", ["ModalBox", "ConfigurationConstants", "ExchangeNUIConstants", "RightUtilities",
		"NetworkUtilities", "MailServerViewModel", "OAuthAuthenticationMixin"],
		...
		return {
			...
			methods: {
				...
				onDialogButtonClick: function(returnCode) {
					if (returnCode === "LinkToExchangeListenerServiceAcademy") {
						var url = this.get("Resources.Strings.LinkToExchangeListenerServiceAcademyUrl");
