namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class PeriodicitySettings_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : PeriodicitySettings
	{
