namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class TimeUnitEventsProcessSchema : Terrasoft.Configuration.TimeUnit_Calendar_TerrasoftEventsProcessSchema
	{
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "TimeUnit_SSPEventsProcess";
			UId = new Guid("8b85c2ef-e742-4536-b013-973985ec33e8");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("4b51e7e1-ba42-43ed-8eae-3072d53b809f");
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8b85c2ef-e742-4536-b013-973985ec33e8"));
		}
