namespace Terrasoft.Configuration
{
	...
	public class AccountInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountInFolderEventsProcessSchema() {
			var schema = new AccountInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountInFolderEventsProcessSchema

	/// <exclude/>
	public class AccountInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public AccountInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountInFolderEventsProcessSchema(AccountInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new AccountInFolderEventsProcessSchema(this);
		}
