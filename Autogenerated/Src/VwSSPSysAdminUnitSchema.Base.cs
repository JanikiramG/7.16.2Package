namespace Terrasoft.Configuration
{
	...
	public class VwSSPSysAdminUnitSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSSPSysAdminUnitEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSSPSysAdminUnitEventsProcessSchema() {
			var schema = new VwSSPSysAdminUnitEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSSPSysAdminUnitEventsProcessSchema

	/// <exclude/>
	public class VwSSPSysAdminUnitEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public VwSSPSysAdminUnitEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSSPSysAdminUnitEventsProcessSchema(VwSSPSysAdminUnitEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSSPSysAdminUnit_BaseEventsProcess";
			UId = new Guid("63e8b94d-3d0e-4735-8054-f8d44c28dfa8");
			CreatedInPackageId = new Guid("ae30d032-d762-4543-9b23-f4ddeb135bae");
		...
		public override object Clone() {
			return new VwSSPSysAdminUnitEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("63e8b94d-3d0e-4735-8054-f8d44c28dfa8"));
		}
