namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChangeLogEntity_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ChangeLogEntity
	{
