namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMsgUserStateInLib_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysMsgUserStateInLib
	{
