namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Account_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.Account_BaseEventsProcess<TEntity> where TEntity : Account_EmailMining_Terrasoft
	{
