namespace Terrasoft.Configuration
{
	...
	public class ProductInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductInFolderEventsProcessSchema() {
			var schema = new ProductInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductInFolderEventsProcessSchema

	/// <exclude/>
	public class ProductInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ProductInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductInFolderEventsProcessSchema(ProductInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductInFolder_BaseEventsProcess";
			UId = new Guid("112ce7c5-4913-4ede-ad2a-d0e35fe19dd3");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ProductInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("112ce7c5-4913-4ede-ad2a-d0e35fe19dd3"));
		}
