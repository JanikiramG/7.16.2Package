namespace Terrasoft.Configuration
{
	...
	public class DeliveryTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDeliveryTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDeliveryTypeEventsProcessSchema() {
			var schema = new DeliveryTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DeliveryTypeEventsProcessSchema

	/// <exclude/>
	public class DeliveryTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DeliveryTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DeliveryTypeEventsProcessSchema(DeliveryTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DeliveryType_OrderEventsProcess";
			UId = new Guid("8e90bf4d-08fb-4fcf-92ec-9fcf3a8fd956");
			CreatedInPackageId = new Guid("dc9b0a8f-3f62-409f-a803-948a13d96822");
		...
		public override object Clone() {
			return new DeliveryTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8e90bf4d-08fb-4fcf-92ec-9fcf3a8fd956"));
		}
