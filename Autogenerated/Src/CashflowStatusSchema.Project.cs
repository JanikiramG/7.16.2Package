namespace Terrasoft.Configuration
{
	...
	public class CashflowStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCashflowStatusEventsProcessSchema();
		}
	...
	#region Class: CashflowStatusEventsProcessSchema

	/// <exclude/>
	public class CashflowStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CashflowStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CashflowStatus_ProjectEventsProcess";
			UId = new Guid("f534f3e8-50bc-4d0d-9d82-6a8795843f6d");
			CreatedInPackageId = new Guid("fe2bb0e4-061e-41b1-be85-5078c802043f");
		...
		public override object Clone() {
			return new CashflowStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f534f3e8-50bc-4d0d-9d82-6a8795843f6d"));
		}
