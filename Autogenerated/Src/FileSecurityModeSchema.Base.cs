namespace Terrasoft.Configuration
{
	...
	public class FileSecurityModeSchema : Terrasoft.Configuration.LookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFileSecurityModeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFileSecurityModeEventsProcessSchema() {
			var schema = new FileSecurityModeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: FileSecurityModeEventsProcessSchema

	/// <exclude/>
	public class FileSecurityModeEventsProcessSchema : Terrasoft.Configuration.LookupEventsProcessSchema
	{

		#region Constructors: Public

		public FileSecurityModeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FileSecurityModeEventsProcessSchema(FileSecurityModeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FileSecurityMode_BaseEventsProcess";
			UId = new Guid("2ab3c993-e17d-46bc-8a8f-c2ca5921136b");
			CreatedInPackageId = new Guid("3c624d29-361c-47f2-ac8f-7824eb3cde6f");
		...
		public override object Clone() {
			return new FileSecurityModeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2ab3c993-e17d-46bc-8a8f-c2ca5921136b"));
		}
