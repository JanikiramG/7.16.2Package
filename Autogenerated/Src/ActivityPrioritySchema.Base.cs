namespace Terrasoft.Configuration
{
	...
	public class ActivityPrioritySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivityPriorityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivityPriorityEventsProcessSchema() {
			var schema = new ActivityPriorityEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ActivityPriorityEventsProcessSchema

	/// <exclude/>
	public class ActivityPriorityEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ActivityPriorityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ActivityPriorityEventsProcessSchema(ActivityPriorityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ActivityPriority_BaseEventsProcess";
			UId = new Guid("76a0f554-bbda-41b9-a18c-7173b9eac818");
		...
		public override object Clone() {
			return new ActivityPriorityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("76a0f554-bbda-41b9-a18c-7173b9eac818"));
		}
