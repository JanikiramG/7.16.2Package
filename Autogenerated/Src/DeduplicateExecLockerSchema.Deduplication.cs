namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DeduplicateExecLocker_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : DeduplicateExecLocker
	{
