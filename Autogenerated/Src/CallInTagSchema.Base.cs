namespace Terrasoft.Configuration
{
	...
	public class CallInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCallInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCallInTagEventsProcessSchema() {
			var schema = new CallInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CallInTagEventsProcessSchema

	/// <exclude/>
	public class CallInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public CallInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CallInTagEventsProcessSchema(CallInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CallInTag_BaseEventsProcess";
			UId = new Guid("4866caa1-dc0a-4515-8cf1-c0e691bd567e");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new CallInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4866caa1-dc0a-4515-8cf1-c0e691bd567e"));
		}
