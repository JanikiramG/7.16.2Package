namespace Terrasoft.Configuration
{
	...
	public class SysProcessElementDataSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysProcessElementDataEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysProcessElementDataEventsProcessSchema() {
			var schema = new SysProcessElementDataEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysProcessElementData_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysProcessElementData
	{
	...
	#region Class: SysProcessElementDataEventsProcessSchema

	/// <exclude/>
	public class SysProcessElementDataEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysProcessElementDataEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysProcessElementDataEventsProcessSchema(SysProcessElementDataEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysProcessElementData_BaseEventsProcess";
			UId = new Guid("719ea039-a4a9-411e-b574-de59eed1a1a8");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysProcessElementDataEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("719ea039-a4a9-411e-b574-de59eed1a1a8"));
		}
