namespace Terrasoft.Configuration
{
	...
	public class AccountOwnershipSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountOwnershipEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountOwnershipEventsProcessSchema() {
			var schema = new AccountOwnershipEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountOwnershipEventsProcessSchema

	/// <exclude/>
	public class AccountOwnershipEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public AccountOwnershipEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountOwnershipEventsProcessSchema(AccountOwnershipEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountOwnership_BaseEventsProcess";
			UId = new Guid("26a5318c-ae23-468f-8428-6809c8cbadad");
		...
		public override object Clone() {
			return new AccountOwnershipEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("26a5318c-ae23-468f-8428-6809c8cbadad"));
		}
