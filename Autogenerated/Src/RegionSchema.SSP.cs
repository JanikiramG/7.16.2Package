namespace Terrasoft.Configuration
{
	...
	public class RegionSchema : Terrasoft.Configuration.Region_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateRegionEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateRegionEventsProcessSchema() {
			var schema = new RegionEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: RegionEventsProcessSchema

	/// <exclude/>
	public class RegionEventsProcessSchema : Terrasoft.Configuration.Region_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public RegionEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public RegionEventsProcessSchema(RegionEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Region_SSPEventsProcess";
			UId = new Guid("57131fcd-395f-4e04-a284-37fbba66121a");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("d9d6165d-aa5f-49f9-8704-a58d7cc7d7e9");
		...
		public override object Clone() {
			return new RegionEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("57131fcd-395f-4e04-a284-37fbba66121a"));
		}
