namespace Terrasoft.Configuration
{
	...
	public class IntegrationResultSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateIntegrationResultEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateIntegrationResultEventsProcessSchema() {
			var schema = new IntegrationResultEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: IntegrationResultEventsProcessSchema

	/// <exclude/>
	public class IntegrationResultEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public IntegrationResultEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public IntegrationResultEventsProcessSchema(IntegrationResultEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "IntegrationResult_BaseEventsProcess";
			UId = new Guid("ff2deabf-4693-4ebe-a0e7-e229731afec8");
		...
		public override object Clone() {
			return new IntegrationResultEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ff2deabf-4693-4ebe-a0e7-e229731afec8"));
		}
