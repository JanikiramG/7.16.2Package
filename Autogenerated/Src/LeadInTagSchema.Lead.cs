namespace Terrasoft.Configuration
{
	...
	public class LeadInTag_Lead_TerrasoftSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadInTag_Lead_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadInTag_Lead_TerrasoftEventsProcessSchema() {
			var schema = new LeadInTag_Lead_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadInTag_Lead_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class LeadInTag_Lead_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public LeadInTag_Lead_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadInTag_Lead_TerrasoftEventsProcessSchema(LeadInTag_Lead_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadInTag_LeadEventsProcess";
			UId = new Guid("f35df262-615d-4ecf-8df3-0ff619549e21");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new LeadInTag_Lead_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f35df262-615d-4ecf-8df3-0ff619549e21"));
		}
