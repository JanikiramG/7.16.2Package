namespace Terrasoft.Configuration
{
	...
	public class ContractType_CoreContracts_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContractType_CoreContracts_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContractType_CoreContracts_TerrasoftEventsProcessSchema() {
			var schema = new ContractType_CoreContracts_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContractType_CoreContracts_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class ContractType_CoreContracts_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ContractType_CoreContracts_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContractType_CoreContracts_TerrasoftEventsProcessSchema(ContractType_CoreContracts_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContractType_CoreContractsEventsProcess";
			UId = new Guid("06b9d607-7cdd-41f5-b274-1586526663d4");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ContractType_CoreContracts_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("06b9d607-7cdd-41f5-b274-1586526663d4"));
		}
