namespace Terrasoft.Configuration
{
	...
	public class SysAdminOperationFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysAdminOperationFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysAdminOperationFolderEventsProcessSchema() {
			var schema = new SysAdminOperationFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysAdminOperationFolderEventsProcessSchema

	/// <exclude/>
	public class SysAdminOperationFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public SysAdminOperationFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysAdminOperationFolderEventsProcessSchema(SysAdminOperationFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysAdminOperationFolder_BaseEventsProcess";
			UId = new Guid("3176842f-83fb-46ee-8530-de5914492b7b");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysAdminOperationFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3176842f-83fb-46ee-8530-de5914492b7b"));
		}
