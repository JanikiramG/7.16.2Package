namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MultiDeleteQueue_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : MultiDeleteQueue
	{
