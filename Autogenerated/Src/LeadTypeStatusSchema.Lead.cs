namespace Terrasoft.Configuration
{
	...
	public class LeadTypeStatus_Lead_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new LeadTypeStatus_LeadEventsProcess(userConnection);
		}
	...
	public class LeadTypeStatus_Lead_Terrasoft : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("LeadTypeStatus_Lead_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class LeadTypeStatus_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadTypeStatus_Lead_Terrasoft
	{
	...
	public partial class LeadTypeStatus_LeadEventsProcess<TEntity>
	{
