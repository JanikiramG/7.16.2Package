namespace Terrasoft.Configuration
{
	...
	public class SysEntitySchemaRecOprRightLvlSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysEntitySchemaRecOprRightLvlEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysEntitySchemaRecOprRightLvlEventsProcessSchema() {
			var schema = new SysEntitySchemaRecOprRightLvlEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysEntitySchemaRecOprRightLvlEventsProcessSchema

	/// <exclude/>
	public class SysEntitySchemaRecOprRightLvlEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysEntitySchemaRecOprRightLvlEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysEntitySchemaRecOprRightLvlEventsProcessSchema(SysEntitySchemaRecOprRightLvlEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysEntitySchemaRecOprRightLvl_BaseEventsProcess";
			UId = new Guid("5c670852-d3c7-4841-a577-2e535d66aa98");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysEntitySchemaRecOprRightLvlEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5c670852-d3c7-4841-a577-2e535d66aa98"));
		}
