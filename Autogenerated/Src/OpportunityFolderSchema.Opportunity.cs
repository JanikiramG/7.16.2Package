namespace Terrasoft.Configuration
{
	...
	public class OpportunityFolder_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityFolder_Opportunity_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityFolder_Opportunity_TerrasoftEventsProcessSchema() {
			var schema = new OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema(OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityFolder_OpportunityEventsProcess";
			UId = new Guid("f934feb5-ad35-4c9d-bd64-0e8b19f9f631");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new OpportunityFolder_Opportunity_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f934feb5-ad35-4c9d-bd64-0e8b19f9f631"));
		}
