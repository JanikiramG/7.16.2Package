namespace Terrasoft.Configuration
{
	...
	public class VwModuleEditInfoSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwModuleEditInfoEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwModuleEditInfoEventsProcessSchema() {
			var schema = new VwModuleEditInfoEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwModuleEditInfoEventsProcessSchema

	/// <exclude/>
	public class VwModuleEditInfoEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwModuleEditInfoEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwModuleEditInfoEventsProcessSchema(VwModuleEditInfoEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwModuleEditInfo_PlatformEventsProcess";
			UId = new Guid("d3b04419-15d0-427e-b638-f1dc0020d3f8");
			CreatedInPackageId = new Guid("69e251dd-db32-44f2-a05d-77898f910c49");
		...
		public override object Clone() {
			return new VwModuleEditInfoEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("d3b04419-15d0-427e-b638-f1dc0020d3f8"));
		}
