namespace Terrasoft.Configuration
{
	...
	public class MLModelTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMLModelTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMLModelTagEventsProcessSchema() {
			var schema = new MLModelTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: MLModelTagEventsProcessSchema

	/// <exclude/>
	public class MLModelTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public MLModelTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MLModelTagEventsProcessSchema(MLModelTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MLModelTag_MLEventsProcess";
			UId = new Guid("fe4208ff-bdc8-42fa-bb3c-4e4e621a0310");
			CreatedInPackageId = new Guid("33c09d4f-db5e-4d77-bac6-f1fd801beedb");
		...
		public override object Clone() {
			return new MLModelTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fe4208ff-bdc8-42fa-bb3c-4e4e621a0310"));
		}
