define("PivotTableDesigner", ["PivotTableDesignerResources", "PivotTable"], 
		function(resources) {
	/**
	...
	Ext.define("Terrasoft.controls.PivotTableDesigner", {
		 ...
		 * @override
		 */
		getControlConfigEventName: "getPivotTableDesignerConfig", 

		/**
		 * @inheritDoc
		 * @override
		 */
		setControlConfigEventName: "setPivotTableDesignerConfig", 
