namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EntityConnBinding_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : EntityConnBinding
	{
