namespace Terrasoft.Configuration
{
	...
	public class DeadlineCalcSchemas_Calendar_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema() {
			var schema = new DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema(DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema(this);
		}
