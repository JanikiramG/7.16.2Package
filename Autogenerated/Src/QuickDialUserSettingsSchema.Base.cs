namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QuickDialUserSettings_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : QuickDialUserSettings
	{
