namespace Terrasoft.Configuration
{
	...
	public class MonthSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMonthEventsProcessSchema();
		}
	...
	#region Class: MonthEventsProcessSchema

	/// <exclude/>
	public class MonthEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public MonthEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Month_BaseEventsProcess";
			UId = new Guid("191e6bd2-a829-4329-9a4f-144607894a5e");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new MonthEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("191e6bd2-a829-4329-9a4f-144607894a5e"));
		}
