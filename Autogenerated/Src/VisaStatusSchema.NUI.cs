namespace Terrasoft.Configuration
{
	...
	public class VisaStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVisaStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVisaStatusEventsProcessSchema() {
			var schema = new VisaStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VisaStatusEventsProcessSchema

	/// <exclude/>
	public class VisaStatusEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public VisaStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VisaStatusEventsProcessSchema(VisaStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VisaStatus_NUIEventsProcess";
			UId = new Guid("71a4c4b3-f1df-4dda-b0ed-acd9ce5be726");
			CreatedInPackageId = new Guid("30bec7d4-5068-42a2-ab31-4d4a3fc4e524");
		...
		public override object Clone() {
			return new VisaStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("71a4c4b3-f1df-4dda-b0ed-acd9ce5be726"));
		}
