namespace Terrasoft.Configuration
{
	...
	public class LookupInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLookupInTagEventsProcessSchema();
		}
	...
	#region Class: LookupInTagEventsProcessSchema

	/// <exclude/>
	public class LookupInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public LookupInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LookupInTag_BaseEventsProcess";
			UId = new Guid("abfaeb47-d341-450a-81c8-6e1b69218cf0");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new LookupInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("abfaeb47-d341-450a-81c8-6e1b69218cf0"));
		}
