namespace Terrasoft.Configuration
{
	...
	public class Job_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateJob_Base_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateJob_Base_TerrasoftEventsProcessSchema() {
			var schema = new Job_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: Job_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Job_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public Job_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Job_Base_TerrasoftEventsProcessSchema(Job_Base_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Job_BaseEventsProcess";
			UId = new Guid("92f83f9c-f333-4f92-a44b-1b0d1a965235");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new Job_Base_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("92f83f9c-f333-4f92-a44b-1b0d1a965235"));
		}
