namespace Terrasoft.Configuration
{
	...
	public class ProductTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductTagEventsProcessSchema() {
			var schema = new ProductTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductTagEventsProcessSchema

	/// <exclude/>
	public class ProductTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ProductTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductTagEventsProcessSchema(ProductTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductTag_BaseEventsProcess";
			UId = new Guid("204a2a10-f71c-4a9c-a99b-41fedfcb4767");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ProductTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("204a2a10-f71c-4a9c-a99b-41fedfcb4767"));
		}
