namespace Terrasoft.Configuration
{
	...
	public class SocialMentionSearchRuleSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSocialMentionSearchRuleEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSocialMentionSearchRuleEventsProcessSchema() {
			var schema = new SocialMentionSearchRuleEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SocialMentionSearchRule_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SocialMentionSearchRule
	{
	...
	#region Class: SocialMentionSearchRuleEventsProcessSchema

	/// <exclude/>
	public class SocialMentionSearchRuleEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SocialMentionSearchRuleEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SocialMentionSearchRuleEventsProcessSchema(SocialMentionSearchRuleEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SocialMentionSearchRule_ESNEventsProcess";
			UId = new Guid("3724a824-8fe7-413e-b08a-bbf80ff594ad");
			CreatedInPackageId = new Guid("3c726abc-cc67-49b0-9345-f38bdff9ced8");
		...
		public override object Clone() {
			return new SocialMentionSearchRuleEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3724a824-8fe7-413e-b08a-bbf80ff594ad"));
		}
