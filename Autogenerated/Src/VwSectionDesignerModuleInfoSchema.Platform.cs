namespace Terrasoft.Configuration
{
	...
	public class VwSectionDesignerModuleInfoSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSectionDesignerModuleInfoEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSectionDesignerModuleInfoEventsProcessSchema() {
			var schema = new VwSectionDesignerModuleInfoEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSectionDesignerModuleInfoEventsProcessSchema

	/// <exclude/>
	public class VwSectionDesignerModuleInfoEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwSectionDesignerModuleInfoEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSectionDesignerModuleInfoEventsProcessSchema(VwSectionDesignerModuleInfoEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSectionDesignerModuleInfo_PlatformEventsProcess";
			UId = new Guid("67a65293-108f-4e40-9575-7057d891bbda");
			CreatedInPackageId = new Guid("69e251dd-db32-44f2-a05d-77898f910c49");
		...
		public override object Clone() {
			return new VwSectionDesignerModuleInfoEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("67a65293-108f-4e40-9575-7057d891bbda"));
		}
