namespace Terrasoft.Configuration
{
	...
	public class ProjectInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProjectInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProjectInTagEventsProcessSchema() {
			var schema = new ProjectInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProjectInTagEventsProcessSchema

	/// <exclude/>
	public class ProjectInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ProjectInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProjectInTagEventsProcessSchema(ProjectInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProjectInTag_ProjectEventsProcess";
			UId = new Guid("cb401dd7-117a-44ae-a246-3d8395263ca5");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ProjectInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("cb401dd7-117a-44ae-a246-3d8395263ca5"));
		}
