namespace Terrasoft.Core.Process
{
	...
	public class LeadManagementDisqualificationSchema : Terrasoft.Core.Process.ProcessSchema
	{
		...
		protected virtual void InitializeReadContactDataUserTaskParameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			var resultCompositeObjectListParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("f3b8d488-c37f-4160-a4fe-6e882d014c0d"),
				ContainerUId = new Guid("d587fc99-d596-473e-8b4c-47ed99139561"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("cb455b6f-78ff-4b1e-b241-c2bbc0b37e9f"),
			...
			var considerTimeInFilterParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("6a61e7d2-047a-4411-b976-7fbd16463fd6"),
				ContainerUId = new Guid("d587fc99-d596-473e-8b4c-47ed99139561"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("cb455b6f-78ff-4b1e-b241-c2bbc0b37e9f"),
		...
		protected virtual void InitializeReadLeadDataUserTaskParameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			parametrizedElement.Parameters.Add(ignoreDisplayValuesParameter);
			var resultCompositeObjectListParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("e616fb4d-6350-4567-9cbf-f077bf230f0e"),
				ContainerUId = new Guid("5c812ead-9e0e-4e95-91c1-b0a297de4131"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("cb455b6f-78ff-4b1e-b241-c2bbc0b37e9f"),
			...
			parametrizedElement.Parameters.Add(resultCompositeObjectListParameter);
			var considerTimeInFilterParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("004c6278-b894-4fc7-8f84-895c1311f7df"),
				ContainerUId = new Guid("5c812ead-9e0e-4e95-91c1-b0a297de4131"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("cb455b6f-78ff-4b1e-b241-c2bbc0b37e9f"),
	...
	public class LeadManagementDisqualification : Terrasoft.Core.Process.Process
	{
		...
		protected override void InitializeMetaPathParameterValues() {
			...
			MetaPathParameterValues.Add("f3b8d488-c37f-4160-a4fe-6e882d014c0d", () => ReadContactDataUserTask.ResultCompositeObjectList);
			MetaPathParameterValues.Add("6a61e7d2-047a-4411-b976-7fbd16463fd6", () => ReadContactDataUserTask.ConsiderTimeInFilter);
			...
			MetaPathParameterValues.Add("e616fb4d-6350-4567-9cbf-f077bf230f0e", () => ReadLeadDataUserTask.ResultCompositeObjectList);
			MetaPathParameterValues.Add("004c6278-b894-4fc7-8f84-895c1311f7df", () => ReadLeadDataUserTask.ConsiderTimeInFilter);
		}
