define("MLModelMiniPage", ["MLConfigurationConsts", "MLModelPageResources", "RootSchemaLookupMixin"],
	...
	return {
		...
		methods: {
			...
			setCFUserColumnRequired: function() {
				return this._setCFColumnRequired("CFUserColumn");
			},
			...
			setCFItemColumnRequired: function() {
				return this._setCFColumnRequired("CFItemColumn");
			},
			...
			getCFInteractionValueColumnHint: function() {
				return modelPageResources.localizableStrings.CFInteractionValueColumnHint;
			},
			...
			getRootSchemaCaption: function() {
				return this.getIsCF()
					? modelPageResources.localizableStrings.CFRootSchemaCaption
			...
			getRootSchemaHint: function() {
				return this.getIsCF()
					? modelPageResources.localizableStrings.CFRootSchemaHint
