namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPackageHierarchy_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysPackageHierarchy
	{
