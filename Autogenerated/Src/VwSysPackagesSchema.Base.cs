namespace Terrasoft.Configuration
{
	...
	public class VwSysPackagesSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSysPackagesEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSysPackagesEventsProcessSchema() {
			var schema = new VwSysPackagesEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class VwSysPackages_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwSysPackages
	{
	...
	#region Class: VwSysPackagesEventsProcessSchema

	/// <exclude/>
	public class VwSysPackagesEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public VwSysPackagesEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSysPackagesEventsProcessSchema(VwSysPackagesEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSysPackages_BaseEventsProcess";
			UId = new Guid("a4f0b6f1-3b41-43bc-9fe2-b15493a413bb");
			CreatedInPackageId = new Guid("1234f32b-eaf1-4f76-b06d-73277e6c9746");
		...
		public override object Clone() {
			return new VwSysPackagesEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a4f0b6f1-3b41-43bc-9fe2-b15493a413bb"));
		}
