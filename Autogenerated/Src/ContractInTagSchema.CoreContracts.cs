namespace Terrasoft.Configuration
{
	...
	public class ContractInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContractInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContractInTagEventsProcessSchema() {
			var schema = new ContractInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContractInTagEventsProcessSchema

	/// <exclude/>
	public class ContractInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ContractInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContractInTagEventsProcessSchema(ContractInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContractInTag_CoreContractsEventsProcess";
			UId = new Guid("0f3a2535-b7ab-42f5-aede-db72d1d88ed9");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ContractInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0f3a2535-b7ab-42f5-aede-db72d1d88ed9"));
		}
