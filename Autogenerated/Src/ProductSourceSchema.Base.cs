namespace Terrasoft.Configuration
{
	...
	public class ProductSourceSchema : Terrasoft.Configuration.BaseImageLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductSourceEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductSourceEventsProcessSchema() {
			var schema = new ProductSourceEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductSourceEventsProcessSchema

	/// <exclude/>
	public class ProductSourceEventsProcessSchema : Terrasoft.Configuration.BaseImageLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ProductSourceEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductSourceEventsProcessSchema(ProductSourceEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductSource_BaseEventsProcess";
			UId = new Guid("7cafc2aa-bef8-47b8-8496-dc6446d64961");
		...
		public override object Clone() {
			return new ProductSourceEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7cafc2aa-bef8-47b8-8496-dc6446d64961"));
		}
