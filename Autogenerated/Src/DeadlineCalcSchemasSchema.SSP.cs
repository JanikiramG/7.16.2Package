namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class DeadlineCalcSchemasEventsProcessSchema : Terrasoft.Configuration.DeadlineCalcSchemas_Calendar_TerrasoftEventsProcessSchema
	{
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DeadlineCalcSchemas_SSPEventsProcess";
			UId = new Guid("0c4f8b73-126d-4e7b-a3ce-82c2fca7653d");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("86bf808c-0def-4371-bcb7-41328f64ce6a");
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0c4f8b73-126d-4e7b-a3ce-82c2fca7653d"));
		}
