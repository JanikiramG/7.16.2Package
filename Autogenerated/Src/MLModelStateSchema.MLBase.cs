namespace Terrasoft.Configuration
{
	...
	public class MLModelStateSchema : Terrasoft.Configuration.SysCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMLModelStateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMLModelStateEventsProcessSchema() {
			var schema = new MLModelStateEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: MLModelStateEventsProcessSchema

	/// <exclude/>
	public class MLModelStateEventsProcessSchema : Terrasoft.Configuration.SysCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public MLModelStateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MLModelStateEventsProcessSchema(MLModelStateEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MLModelState_MLBaseEventsProcess";
			UId = new Guid("69ee0a2a-5e69-4ef2-86d2-64655f09789a");
			CreatedInPackageId = new Guid("62fdb191-1544-4399-9d20-c308d8466eaa");
		...
		public override object Clone() {
			return new MLModelStateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("69ee0a2a-5e69-4ef2-86d2-64655f09789a"));
		}
