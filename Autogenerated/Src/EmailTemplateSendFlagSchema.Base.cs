namespace Terrasoft.Configuration
{
	...
	public class EmailTemplateSendFlagSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEmailTemplateSendFlagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEmailTemplateSendFlagEventsProcessSchema() {
			var schema = new EmailTemplateSendFlagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EmailTemplateSendFlagEventsProcessSchema

	/// <exclude/>
	public class EmailTemplateSendFlagEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EmailTemplateSendFlagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EmailTemplateSendFlagEventsProcessSchema(EmailTemplateSendFlagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EmailTemplateSendFlag_BaseEventsProcess";
			UId = new Guid("ff1a3c2b-2286-45dc-a46d-89dab272aadf");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new EmailTemplateSendFlagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ff1a3c2b-2286-45dc-a46d-89dab272aadf"));
		}
