namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysModuleSchemaEdit_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwSysModuleSchemaEdit
	{
