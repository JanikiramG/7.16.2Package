namespace Terrasoft.Configuration
{
	...
	public class ActivitySyncSettingsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivitySyncSettingsEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivitySyncSettingsEventsProcessSchema() {
			var schema = new ActivitySyncSettingsEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class ActivitySyncSettings_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ActivitySyncSettings
	{
	...
	#region Class: ActivitySyncSettingsEventsProcessSchema

	/// <exclude/>
	public class ActivitySyncSettingsEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public ActivitySyncSettingsEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ActivitySyncSettingsEventsProcessSchema(ActivitySyncSettingsEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ActivitySyncSettings_ExchangeEventsProcess";
			UId = new Guid("19469731-02f3-40b8-ab2c-7e00857173e3");
			CreatedInPackageId = new Guid("3033db6d-23fb-435c-94e5-8f4806c46ba3");
		...
		public override object Clone() {
			return new ActivitySyncSettingsEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("19469731-02f3-40b8-ab2c-7e00857173e3"));
		}
