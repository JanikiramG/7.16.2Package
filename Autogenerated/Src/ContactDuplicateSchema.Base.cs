namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactDuplicate_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ContactDuplicate
	{
