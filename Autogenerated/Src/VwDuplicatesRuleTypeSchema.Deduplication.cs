namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwDuplicatesRuleType_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwDuplicatesRuleType
	{
