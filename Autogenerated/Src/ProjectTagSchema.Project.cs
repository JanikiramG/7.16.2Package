namespace Terrasoft.Configuration
{
	...
	public class ProjectTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProjectTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProjectTagEventsProcessSchema() {
			var schema = new ProjectTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProjectTagEventsProcessSchema

	/// <exclude/>
	public class ProjectTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ProjectTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProjectTagEventsProcessSchema(ProjectTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProjectTag_ProjectEventsProcess";
			UId = new Guid("23cdfec8-271a-431e-b5e5-7719f6fe82f6");
			CreatedInPackageId = new Guid("dfe2c6b5-61e8-4e57-95ae-a3c34fa0908f");
		...
		public override object Clone() {
			return new ProjectTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("23cdfec8-271a-431e-b5e5-7719f6fe82f6"));
		}
