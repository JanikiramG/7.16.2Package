define("ApplicationStructureWizardUtils", ["terrasoft", "ApplicationStructureWizardUtilsResources",
	...
	Ext.define("Terrasoft.configuration.ApplicationStructureWizardUtils", {
		...
		createSectionEntity: function(callback, config) {
			...
			this.addNameColumn(newSchema);
			this.addNotesColumn(newSchema);
			newSchema.setParent(Terrasoft.DesignTimeEnums.BaseSchemaUId.BASE_ENTITY, function() {
		 ...
		 */
		addNameColumn: function(newSchema) {
		 ...
		 * @param {Terrasoft.EntitySchemaManagerItem} newSchema Target schema.
		 */
		addNotesColumn: function(newSchema) {
			...
			notesColumn.setLocalizableStringPropertyValue("caption", resources.localizableStrings.NotesColumnCaption);
