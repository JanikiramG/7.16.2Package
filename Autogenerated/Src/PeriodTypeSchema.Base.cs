namespace Terrasoft.Configuration
{
	...
	public class PeriodTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePeriodTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePeriodTypeEventsProcessSchema() {
			var schema = new PeriodTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PeriodTypeEventsProcessSchema

	/// <exclude/>
	public class PeriodTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public PeriodTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PeriodTypeEventsProcessSchema(PeriodTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PeriodType_BaseEventsProcess";
			UId = new Guid("23e5f5ea-f3af-4f7a-b5d9-09b91c81a047");
			CreatedInPackageId = new Guid("bb5b13b5-8833-41e4-a262-01f88b33e376");
		...
		public override object Clone() {
			return new PeriodTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("23e5f5ea-f3af-4f7a-b5d9-09b91c81a047"));
		}
