namespace Terrasoft.Configuration
{
	...
	public class ProductInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductInTagEventsProcessSchema() {
			var schema = new ProductInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductInTagEventsProcessSchema

	/// <exclude/>
	public class ProductInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ProductInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductInTagEventsProcessSchema(ProductInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductInTag_BaseEventsProcess";
			UId = new Guid("0222040b-3f37-4b5a-b44d-ab4059191c8a");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ProductInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0222040b-3f37-4b5a-b44d-ab4059191c8a"));
		}
