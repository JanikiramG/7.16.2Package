namespace Terrasoft.Configuration
{
	...
	public class PortalSchemaAccessListSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePortalSchemaAccessListEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePortalSchemaAccessListEventsProcessSchema() {
			var schema = new PortalSchemaAccessListEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class PortalSchemaAccessList_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : PortalSchemaAccessList
	{
	...
	#region Class: PortalSchemaAccessListEventsProcessSchema

	/// <exclude/>
	public class PortalSchemaAccessListEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public PortalSchemaAccessListEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PortalSchemaAccessListEventsProcessSchema(PortalSchemaAccessListEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PortalSchemaAccessList_NUIEventsProcess";
			UId = new Guid("bd3ff763-0fa6-4c0b-b4c3-4ce71e4d0450");
			CreatedInPackageId = new Guid("6ba26f98-9709-4408-98d0-761f0c4bf2aa");
		...
		public override object Clone() {
			return new PortalSchemaAccessListEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("bd3ff763-0fa6-4c0b-b4c3-4ce71e4d0450"));
		}
