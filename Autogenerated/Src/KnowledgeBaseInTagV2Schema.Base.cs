namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseInTagV2Schema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBaseInTagV2EventsProcessSchema();
		}

		protected virtual ProcessSchema CreateKnowledgeBaseInTagV2EventsProcessSchema() {
			var schema = new KnowledgeBaseInTagV2EventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: KnowledgeBaseInTagV2EventsProcessSchema

	/// <exclude/>
	public class KnowledgeBaseInTagV2EventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBaseInTagV2EventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public KnowledgeBaseInTagV2EventsProcessSchema(KnowledgeBaseInTagV2EventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBaseInTagV2_BaseEventsProcess";
			UId = new Guid("ec520508-4096-40ae-8562-2bf007064434");
			CreatedInPackageId = new Guid("7ef175d1-30fa-42f5-9f26-d5b1d45b0001");
		...
		public override object Clone() {
			return new KnowledgeBaseInTagV2EventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ec520508-4096-40ae-8562-2bf007064434"));
		}
