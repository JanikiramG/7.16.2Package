namespace Terrasoft.Configuration
{
	...
	public class ContactAddressSchema : Terrasoft.Configuration.ContactAddress_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContactAddressEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContactAddressEventsProcessSchema() {
			var schema = new ContactAddressEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContactAddressEventsProcessSchema

	/// <exclude/>
	public class ContactAddressEventsProcessSchema : Terrasoft.Configuration.ContactAddress_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public ContactAddressEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContactAddressEventsProcessSchema(ContactAddressEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactAddress_SSPEventsProcess";
			UId = new Guid("df42899c-55bc-488e-bc2f-78f4e72853ae");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("d56ae4d6-efc0-4cc4-849b-2742e97337a8");
		...
		public override object Clone() {
			return new ContactAddressEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("df42899c-55bc-488e-bc2f-78f4e72853ae"));
		}
