namespace Terrasoft.Configuration
{
	...
	public class SysMsgUserStateIconSchema : Terrasoft.Configuration.BaseImageLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysMsgUserStateIconEventsProcessSchema();
		}
	...
	#region Class: SysMsgUserStateIconEventsProcessSchema

	/// <exclude/>
	public class SysMsgUserStateIconEventsProcessSchema : Terrasoft.Configuration.BaseImageLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysMsgUserStateIconEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysMsgUserStateIcon_BaseEventsProcess";
			UId = new Guid("9ffdc6eb-d8e5-47c7-a462-ba64c2ee7f1a");
			CreatedInPackageId = new Guid("cc180df9-46d6-42d1-9563-e9510396b77b");
			...
			ParentSchemaUId = new Guid("4bebfbb7-dd35-4a7a-aeb9-f41a4118d931");
		...
		public override object Clone() {
			return new SysMsgUserStateIconEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9ffdc6eb-d8e5-47c7-a462-ba64c2ee7f1a"));
		}
