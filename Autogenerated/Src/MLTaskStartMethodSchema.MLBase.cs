namespace Terrasoft.Configuration
{
	...
	public class MLTaskStartMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMLTaskStartMethodEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMLTaskStartMethodEventsProcessSchema() {
			var schema = new MLTaskStartMethodEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: MLTaskStartMethodEventsProcessSchema

	/// <exclude/>
	public class MLTaskStartMethodEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public MLTaskStartMethodEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MLTaskStartMethodEventsProcessSchema(MLTaskStartMethodEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MLTaskStartMethod_MLBaseEventsProcess";
			UId = new Guid("0ca9347f-b17f-40ec-b7f8-480725eac997");
			CreatedInPackageId = new Guid("62fdb191-1544-4399-9d20-c308d8466eaa");
		...
		public override object Clone() {
			return new MLTaskStartMethodEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0ca9347f-b17f-40ec-b7f8-480725eac997"));
		}
