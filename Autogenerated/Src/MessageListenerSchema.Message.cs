namespace Terrasoft.Configuration
{
	...
	public class MessageListenerSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMessageListenerEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMessageListenerEventsProcessSchema() {
			var schema = new MessageListenerEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: MessageListenerEventsProcessSchema

	/// <exclude/>
	public class MessageListenerEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public MessageListenerEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MessageListenerEventsProcessSchema(MessageListenerEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MessageListener_MessageEventsProcess";
			UId = new Guid("b3583337-62a5-4cb4-9081-9b0b01df8b34");
			CreatedInPackageId = new Guid("b4ad7210-1e2c-4a25-8f9c-bff818d48783");
		...
		public override object Clone() {
			return new MessageListenerEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b3583337-62a5-4cb4-9081-9b0b01df8b34"));
		}
