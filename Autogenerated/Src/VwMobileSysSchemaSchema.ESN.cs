namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwMobileSysSchema_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwMobileSysSchema
	{
