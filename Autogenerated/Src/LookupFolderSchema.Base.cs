namespace Terrasoft.Configuration
{
	...
	public class LookupFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLookupFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLookupFolderEventsProcessSchema() {
			var schema = new LookupFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LookupFolderEventsProcessSchema

	/// <exclude/>
	public class LookupFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public LookupFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LookupFolderEventsProcessSchema(LookupFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LookupFolder_BaseEventsProcess";
			UId = new Guid("25d39773-ed37-428d-9fd9-82334305c27a");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new LookupFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("25d39773-ed37-428d-9fd9-82334305c27a"));
		}
