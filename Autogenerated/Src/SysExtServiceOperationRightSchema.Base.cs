namespace Terrasoft.Configuration
{
	...
	public class SysExtServiceOperationRightSchema : Terrasoft.Configuration.SysEntitySchemaOperationRightSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysExtServiceOperationRightEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysExtServiceOperationRightEventsProcessSchema() {
			var schema = new SysExtServiceOperationRightEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysExtServiceOperationRightEventsProcessSchema

	/// <exclude/>
	public class SysExtServiceOperationRightEventsProcessSchema : Terrasoft.Configuration.SysEntitySchemaOperationRightEventsProcessSchema
	{

		#region Constructors: Public

		public SysExtServiceOperationRightEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysExtServiceOperationRightEventsProcessSchema(SysExtServiceOperationRightEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysExtServiceOperationRight_BaseEventsProcess";
			UId = new Guid("20d0c757-c2ea-4a48-b106-fd7aaf9aadff");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
			...
			ParentSchemaUId = new Guid("4dde1672-7c72-4e06-b38d-71fa348b115c");
		...
		public override object Clone() {
			return new SysExtServiceOperationRightEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("20d0c757-c2ea-4a48-b106-fd7aaf9aadff"));
		}
