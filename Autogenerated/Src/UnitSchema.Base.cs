namespace Terrasoft.Configuration
{
	...
	public class Unit_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateUnit_Base_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateUnit_Base_TerrasoftEventsProcessSchema() {
			var schema = new Unit_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: Unit_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Unit_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public Unit_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Unit_Base_TerrasoftEventsProcessSchema(Unit_Base_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Unit_BaseEventsProcess";
			UId = new Guid("272403ee-4780-4eed-b4e1-5964bf2011e9");
		...
		public override object Clone() {
			return new Unit_Base_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("272403ee-4780-4eed-b4e1-5964bf2011e9"));
		}
