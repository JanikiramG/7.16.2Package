namespace Terrasoft.Configuration
{
	...
	public class CitySchema : Terrasoft.Configuration.City_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCityEventsProcessSchema() {
			var schema = new CityEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CityEventsProcessSchema

	/// <exclude/>
	public class CityEventsProcessSchema : Terrasoft.Configuration.City_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public CityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CityEventsProcessSchema(CityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "City_SSPEventsProcess";
			UId = new Guid("cdd562ca-3b0a-419b-a19d-3faee80360ee");
			CreatedInPackageId = new Guid("1bc37faf-30bf-4d4a-b067-5fd52b4ccffd");
			...
			ParentSchemaUId = new Guid("f90899cc-964b-46b9-bd12-bbc2c14f2609");
		...
		public override object Clone() {
			return new CityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("cdd562ca-3b0a-419b-a19d-3faee80360ee"));
		}
