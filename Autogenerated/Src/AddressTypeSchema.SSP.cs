namespace Terrasoft.Configuration
{
	...
	public class AddressTypeSchema : Terrasoft.Configuration.AddressType_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAddressTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAddressTypeEventsProcessSchema() {
			var schema = new AddressTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AddressTypeEventsProcessSchema

	/// <exclude/>
	public class AddressTypeEventsProcessSchema : Terrasoft.Configuration.AddressType_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public AddressTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AddressTypeEventsProcessSchema(AddressTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AddressType_SSPEventsProcess";
			UId = new Guid("2d30cb4b-c168-42f4-9f4d-02850f014752");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("7d27833b-58ea-44c0-a8bd-5c30c541d83b");
		...
		public override object Clone() {
			return new AddressTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2d30cb4b-c168-42f4-9f4d-02850f014752"));
		}
