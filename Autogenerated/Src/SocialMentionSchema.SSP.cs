namespace Terrasoft.Configuration
{
	...
	public class SocialMentionSchema : Terrasoft.Configuration.SocialMention_ESN_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSocialMentionEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSocialMentionEventsProcessSchema() {
			var schema = new SocialMentionEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SocialMentionEventsProcessSchema

	/// <exclude/>
	public class SocialMentionEventsProcessSchema : Terrasoft.Configuration.SocialMention_ESN_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SocialMentionEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SocialMentionEventsProcessSchema(SocialMentionEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SocialMention_SSPEventsProcess";
			UId = new Guid("71434dd0-43ac-4d7d-96f1-3ee50a56093d");
			CreatedInPackageId = new Guid("479f70b4-9acf-4e9e-85c9-3a190e2b8f8d");
			...
			ParentSchemaUId = new Guid("08275207-962d-4cd2-8d97-971ffe4f54a0");
		...
		public override object Clone() {
			return new SocialMentionEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("71434dd0-43ac-4d7d-96f1-3ee50a56093d"));
		}
