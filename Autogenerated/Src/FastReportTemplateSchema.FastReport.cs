namespace Terrasoft.Configuration
{
	...
	public class FastReportTemplateSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFastReportTemplateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFastReportTemplateEventsProcessSchema() {
			var schema = new FastReportTemplateEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class FastReportTemplate_FastReportEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : FastReportTemplate
	{
	...
	#region Class: FastReportTemplateEventsProcessSchema

	/// <exclude/>
	public class FastReportTemplateEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public FastReportTemplateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FastReportTemplateEventsProcessSchema(FastReportTemplateEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FastReportTemplate_FastReportEventsProcess";
			UId = new Guid("57353a1f-0177-4f50-a6f4-f242c331f311");
			CreatedInPackageId = new Guid("a4b49bea-882f-4e7d-ae8d-44e3ec2194f3");
		...
		public override object Clone() {
			return new FastReportTemplateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("57353a1f-0177-4f50-a6f4-f242c331f311"));
		}
