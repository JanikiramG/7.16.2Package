namespace Terrasoft.Configuration
{
	...
	public class ProductForecastSchema : Terrasoft.Configuration.EntityInForecastCellSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductForecastEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductForecastEventsProcessSchema() {
			var schema = new ProductForecastEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductForecastEventsProcessSchema

	/// <exclude/>
	public class ProductForecastEventsProcessSchema : Terrasoft.Configuration.EntityInForecastCellEventsProcessSchema
	{

		#region Constructors: Public

		public ProductForecastEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductForecastEventsProcessSchema(ProductForecastEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductForecast_CoreForecastEventsProcess";
			UId = new Guid("e883d050-a927-4e21-a5c7-14aa010b8cf2");
			CreatedInPackageId = new Guid("c5621d45-871a-4a56-adb8-f53023547ef7");
		...
		public override object Clone() {
			return new ProductForecastEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e883d050-a927-4e21-a5c7-14aa010b8cf2"));
		}
