namespace Terrasoft.Configuration
{
	...
	public class ContactInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContactInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContactInTagEventsProcessSchema() {
			var schema = new ContactInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContactInTagEventsProcessSchema

	/// <exclude/>
	public class ContactInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ContactInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContactInTagEventsProcessSchema(ContactInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactInTag_BaseEventsProcess";
			UId = new Guid("f533cce6-edd8-482b-b88b-33c50ab61583");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ContactInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f533cce6-edd8-482b-b88b-33c50ab61583"));
		}
