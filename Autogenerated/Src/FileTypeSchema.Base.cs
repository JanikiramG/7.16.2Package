namespace Terrasoft.Configuration
{
	...
	public class FileTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFileTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFileTypeEventsProcessSchema() {
			var schema = new FileTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: FileTypeEventsProcessSchema

	/// <exclude/>
	public class FileTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public FileTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FileTypeEventsProcessSchema(FileTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FileType_BaseEventsProcess";
			UId = new Guid("2d199b21-7f20-4725-9c95-2f3daaf2f1ac");
		...
		public override object Clone() {
			return new FileTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2d199b21-7f20-4725-9c95-2f3daaf2f1ac"));
		}
