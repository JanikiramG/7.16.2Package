namespace Terrasoft.Configuration
{
	...
	public class ContractFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContractFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContractFolderEventsProcessSchema() {
			var schema = new ContractFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContractFolderEventsProcessSchema

	/// <exclude/>
	public class ContractFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ContractFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContractFolderEventsProcessSchema(ContractFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContractFolder_CoreContractsEventsProcess";
			UId = new Guid("33effffd-a28c-4b86-8645-728b2f53b4d3");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ContractFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("33effffd-a28c-4b86-8645-728b2f53b4d3"));
		}
