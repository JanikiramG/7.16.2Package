namespace Terrasoft.Configuration
{
	...
	public class SysWorkplaceTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysWorkplaceTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysWorkplaceTypeEventsProcessSchema() {
			var schema = new SysWorkplaceTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysWorkplaceTypeEventsProcessSchema

	/// <exclude/>
	public class SysWorkplaceTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysWorkplaceTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysWorkplaceTypeEventsProcessSchema(SysWorkplaceTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysWorkplaceType_NUIEventsProcess";
			UId = new Guid("dec84e94-04cd-419e-8395-cba40d0cff80");
			CreatedInPackageId = new Guid("d9c4378b-4458-41ff-9d84-e4b071fcce18");
		...
		public override object Clone() {
			return new SysWorkplaceTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("dec84e94-04cd-419e-8395-cba40d0cff80"));
		}
