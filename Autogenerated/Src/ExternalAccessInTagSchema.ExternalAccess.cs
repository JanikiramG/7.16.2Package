namespace Terrasoft.Configuration
{
	...
	public class ExternalAccessInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateExternalAccessInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateExternalAccessInTagEventsProcessSchema() {
			var schema = new ExternalAccessInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ExternalAccessInTagEventsProcessSchema

	/// <exclude/>
	public class ExternalAccessInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ExternalAccessInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ExternalAccessInTagEventsProcessSchema(ExternalAccessInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ExternalAccessInTag_ExternalAccessEventsProcess";
			UId = new Guid("2a605c94-8070-4584-a071-ebf64092742b");
			CreatedInPackageId = new Guid("386ac9f6-07c1-4d11-8d16-e4e9424ba4e8");
		...
		public override object Clone() {
			return new ExternalAccessInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2a605c94-8070-4584-a071-ebf64092742b"));
		}
