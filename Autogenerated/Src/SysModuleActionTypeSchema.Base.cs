namespace Terrasoft.Configuration
{
	...
	public class SysModuleActionTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysModuleActionTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysModuleActionTypeEventsProcessSchema() {
			var schema = new SysModuleActionTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysModuleActionTypeEventsProcessSchema

	/// <exclude/>
	public class SysModuleActionTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysModuleActionTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysModuleActionTypeEventsProcessSchema(SysModuleActionTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new SysModuleActionTypeEventsProcessSchema(this);
		}
