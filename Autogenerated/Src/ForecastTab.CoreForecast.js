define("ForecastTab", ["ForecastItem", "ForecastTabResources", "ForecastConstants", "RightUtilities", "PivotGrid",
		...
		"EntityResponseValidationMixin", "LookupMultiAddMixin"],
		...
		return {
			...
			methods: {
				...
				editRights: function(primaryColumnValue) {
					...
					const displayName = currentRecord ? currentRecord.get("Name") : "";
			...
			diff: [
				...
				},
				{
					...
					"propertyName": "items",
					"values": {
						"caption": resources.localizableStrings.Calculate,
						"itemType": this.Terrasoft.ViewItemType.BUTTON,
						"markerValue": "calculateButton",
						"selectors": { "wrapEl": "#calculateButton" },
						"style": this.Terrasoft.controls.ButtonEnums.style.BLUE,
						"classes": { "textClass": ["calculateButton"] },
						"click": { "bindTo": "onCalculateFactClick" },
						"tag": "calculateButton",
