namespace Terrasoft.Configuration
{
	...
	public class FRDataSourceTypeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFRDataSourceTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFRDataSourceTypeEventsProcessSchema() {
			var schema = new FRDataSourceTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class FRDataSourceType_FastReportEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : FRDataSourceType
	{
	...
	#region Class: FRDataSourceTypeEventsProcessSchema

	/// <exclude/>
	public class FRDataSourceTypeEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public FRDataSourceTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FRDataSourceTypeEventsProcessSchema(FRDataSourceTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FRDataSourceType_FastReportEventsProcess";
			UId = new Guid("c2436292-b70b-4660-8d2e-98231fbefc0f");
			CreatedInPackageId = new Guid("0005402e-c4df-422a-beab-65ef1e6175ad");
		...
		public override object Clone() {
			return new FRDataSourceTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c2436292-b70b-4660-8d2e-98231fbefc0f"));
		}
