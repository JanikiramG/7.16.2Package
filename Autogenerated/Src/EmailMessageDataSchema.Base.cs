namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailMessageData_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : EmailMessageData
	{
