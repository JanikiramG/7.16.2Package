namespace Terrasoft.Configuration
{
	...
	public class SysStoringObjectStateSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysStoringObjectStateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysStoringObjectStateEventsProcessSchema() {
			var schema = new SysStoringObjectStateEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysStoringObjectStateEventsProcessSchema

	/// <exclude/>
	public class SysStoringObjectStateEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysStoringObjectStateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysStoringObjectStateEventsProcessSchema(SysStoringObjectStateEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new SysStoringObjectStateEventsProcessSchema(this);
		}
