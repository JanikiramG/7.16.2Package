namespace Terrasoft.Configuration
{
	...
	public class SysLicPackageNamesSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysLicPackageNamesEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysLicPackageNamesEventsProcessSchema() {
			var schema = new SysLicPackageNamesEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysLicPackageNames_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysLicPackageNames
	{
	...
	#region Class: SysLicPackageNamesEventsProcessSchema

	/// <exclude/>
	public class SysLicPackageNamesEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysLicPackageNamesEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysLicPackageNamesEventsProcessSchema(SysLicPackageNamesEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysLicPackageNames_BaseEventsProcess";
			UId = new Guid("6c3a1173-52de-4a06-9759-d119875ab031");
			CreatedInPackageId = new Guid("76eace8e-4a48-486b-bf04-de18fe06b0a2");
			CreatedInSchemaUId = Guid.Empty;
			CreatedInVersion = @"7.15.4.2443";
			CultureName = null;
		...
		public override object Clone() {
			return new SysLicPackageNamesEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("6c3a1173-52de-4a06-9759-d119875ab031"));
		}
