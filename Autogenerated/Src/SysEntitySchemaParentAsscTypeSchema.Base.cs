namespace Terrasoft.Configuration
{
	...
	public class SysEntitySchemaParentAsscTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysEntitySchemaParentAsscTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysEntitySchemaParentAsscTypeEventsProcessSchema() {
			var schema = new SysEntitySchemaParentAsscTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysEntitySchemaParentAsscTypeEventsProcessSchema

	/// <exclude/>
	public class SysEntitySchemaParentAsscTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysEntitySchemaParentAsscTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysEntitySchemaParentAsscTypeEventsProcessSchema(SysEntitySchemaParentAsscTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysEntitySchemaParentAsscType_BaseEventsProcess";
			UId = new Guid("79ee7c52-d1e1-41d8-a591-266eb0e69079");
		...
		public override object Clone() {
			return new SysEntitySchemaParentAsscTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("79ee7c52-d1e1-41d8-a591-266eb0e69079"));
		}
