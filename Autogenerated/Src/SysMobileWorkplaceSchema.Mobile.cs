namespace Terrasoft.Configuration
{
	...
	public class SysMobileWorkplaceSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysMobileWorkplaceEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysMobileWorkplaceEventsProcessSchema() {
			var schema = new SysMobileWorkplaceEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysMobileWorkplace_MobileEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysMobileWorkplace
	{
	...
	#region Class: SysMobileWorkplaceEventsProcessSchema

	/// <exclude/>
	public class SysMobileWorkplaceEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysMobileWorkplaceEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysMobileWorkplaceEventsProcessSchema(SysMobileWorkplaceEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysMobileWorkplace_MobileEventsProcess";
			UId = new Guid("e7a53d94-4f46-4a0d-8865-86975892f8b7");
			CreatedInPackageId = new Guid("590b6b4e-ffef-44c7-9f04-0c51046e124e");
		...
		public override object Clone() {
			return new SysMobileWorkplaceEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e7a53d94-4f46-4a0d-8865-86975892f8b7"));
		}
