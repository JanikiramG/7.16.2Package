namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LDAPUserInLDAPGroup_LDAPEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : LDAPUserInLDAPGroup
	{
