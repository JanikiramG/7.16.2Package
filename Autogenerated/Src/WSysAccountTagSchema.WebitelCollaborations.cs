namespace Terrasoft.Configuration
{
	...
	public class WSysAccountTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateWSysAccountTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateWSysAccountTagEventsProcessSchema() {
			var schema = new WSysAccountTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: WSysAccountTagEventsProcessSchema

	/// <exclude/>
	public class WSysAccountTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public WSysAccountTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public WSysAccountTagEventsProcessSchema(WSysAccountTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "WSysAccountTag_WebitelCollaborationsEventsProcess";
			UId = new Guid("2b281e5f-a418-4130-9dfd-c74a1740bd39");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new WSysAccountTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2b281e5f-a418-4130-9dfd-c74a1740bd39"));
		}
