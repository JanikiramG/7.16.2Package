namespace Terrasoft.Configuration
{
	...
	public class JobChangeReasonSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateJobChangeReasonEventsProcessSchema();
		}
	...
	#region Class: JobChangeReasonEventsProcessSchema

	/// <exclude/>
	public class JobChangeReasonEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public JobChangeReasonEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "JobChangeReason_BaseEventsProcess";
			UId = new Guid("5d803f6b-0392-4c2c-ab41-f35d1ee81544");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new JobChangeReasonEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5d803f6b-0392-4c2c-ab41-f35d1ee81544"));
		}
