namespace Terrasoft.Configuration
{
	...
	public class LeadQualificationSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadQualificationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadQualificationEventsProcessSchema() {
			var schema = new LeadQualificationEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class LeadQualification_CoreLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : LeadQualification
	{
	...
	#region Class: LeadQualificationEventsProcessSchema

	/// <exclude/>
	public class LeadQualificationEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public LeadQualificationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadQualificationEventsProcessSchema(LeadQualificationEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadQualification_CoreLeadEventsProcess";
			UId = new Guid("a0773b01-760d-462d-b8f2-057ac6650e66");
			CreatedInPackageId = new Guid("e0d01508-647f-45d1-be6b-8fb83a5b47c5");
		...
		public override object Clone() {
			return new LeadQualificationEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a0773b01-760d-462d-b8f2-057ac6650e66"));
		}
