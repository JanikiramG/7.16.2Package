namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSchemaProperty_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysSchemaProperty
	{
