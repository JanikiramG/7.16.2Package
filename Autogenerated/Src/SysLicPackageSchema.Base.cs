namespace Terrasoft.Configuration
{
	...
	public class SysLicPackageSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysLicPackageEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysLicPackageEventsProcessSchema() {
			var schema = new SysLicPackageEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysLicPackageEventsProcessSchema

	/// <exclude/>
	public class SysLicPackageEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysLicPackageEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysLicPackageEventsProcessSchema(SysLicPackageEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysLicPackage_BaseEventsProcess";
			UId = new Guid("f5d7c35e-cfe9-469d-aa5e-add3653f32f5");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
			CreatedInSchemaUId = Guid.Empty;
			CultureName = null;
		...
		public override object Clone() {
			return new SysLicPackageEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f5d7c35e-cfe9-469d-aa5e-add3653f32f5"));
		}
