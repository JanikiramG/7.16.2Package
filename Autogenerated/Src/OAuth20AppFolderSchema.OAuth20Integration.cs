namespace Terrasoft.Configuration
{
	...
	public class OAuth20AppFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOAuth20AppFolderEventsProcessSchema();
		}
	...
	#region Class: OAuth20AppFolderEventsProcessSchema

	/// <exclude/>
	public class OAuth20AppFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public OAuth20AppFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OAuth20AppFolder_OAuth20IntegrationEventsProcess";
			UId = new Guid("04ea37b1-602b-471c-a2ed-e773f2c4c42a");
			CreatedInPackageId = new Guid("69832cb9-4518-407d-8490-ad1baa6b0193");
		...
		public override object Clone() {
			return new OAuth20AppFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("04ea37b1-602b-471c-a2ed-e773f2c4c42a"));
		}
