namespace Terrasoft.Configuration
{
	...
	public class DuplicatesHistorySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDuplicatesHistoryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDuplicatesHistoryEventsProcessSchema() {
			var schema = new DuplicatesHistoryEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class DuplicatesHistory_DeduplicationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : DuplicatesHistory
	{
	...
	#region Class: DuplicatesHistoryEventsProcessSchema

	/// <exclude/>
	public class DuplicatesHistoryEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public DuplicatesHistoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DuplicatesHistoryEventsProcessSchema(DuplicatesHistoryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DuplicatesHistory_DeduplicationEventsProcess";
			UId = new Guid("360fb0fe-c704-42e6-a07b-18870aa61057");
			CreatedInPackageId = new Guid("b4492df1-0149-4d4b-a643-21f84c084c9c");
		...
		public override object Clone() {
			return new DuplicatesHistoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("360fb0fe-c704-42e6-a07b-18870aa61057"));
		}
