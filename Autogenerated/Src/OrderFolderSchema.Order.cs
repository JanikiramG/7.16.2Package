namespace Terrasoft.Configuration
{
	...
	public class OrderFolder_Order_TerrasoftSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOrderFolder_Order_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOrderFolder_Order_TerrasoftEventsProcessSchema() {
			var schema = new OrderFolder_Order_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OrderFolder_Order_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class OrderFolder_Order_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public OrderFolder_Order_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OrderFolder_Order_TerrasoftEventsProcessSchema(OrderFolder_Order_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OrderFolder_OrderEventsProcess";
			UId = new Guid("77106a87-1f1a-42bc-95a2-7e52991e3c3f");
			CreatedInPackageId = new Guid("125f8fc5-5cbf-4395-9865-451eb0929445");
		...
		public override object Clone() {
			return new OrderFolder_Order_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("77106a87-1f1a-42bc-95a2-7e52991e3c3f"));
		}
