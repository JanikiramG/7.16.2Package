namespace Terrasoft.Configuration
{
	...
	public class ContactSalutationTypeSchema : Terrasoft.Configuration.ContactSalutationType_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContactSalutationTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContactSalutationTypeEventsProcessSchema() {
			var schema = new ContactSalutationTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContactSalutationTypeEventsProcessSchema

	/// <exclude/>
	public class ContactSalutationTypeEventsProcessSchema : Terrasoft.Configuration.ContactSalutationType_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public ContactSalutationTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContactSalutationTypeEventsProcessSchema(ContactSalutationTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactSalutationType_SSPEventsProcess";
			UId = new Guid("91afb1f6-5e0f-492a-bc15-7c25054f9109");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("6c9d2006-fb54-4953-bb20-0d05a79b0321");
		...
		public override object Clone() {
			return new ContactSalutationTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("91afb1f6-5e0f-492a-bc15-7c25054f9109"));
		}
