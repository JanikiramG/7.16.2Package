define("DuplicatesDetailModuleV2", ["DeduplicationConstants", "BaseNestedModule",
	...
	function(DeduplicationConstants) {
		Ext.define("Terrasoft.configuration.DuplicatesDetailModule", {
			 ...
			 * @type {String}
			 */
			viewModelClassName: Terrasoft.Features.getIsEnabled(DeduplicationConstants.features.lazyDuplicatesPage)
			 ...
			 * @type {String}
			 */
			viewConfigClassName: Terrasoft.Features.getIsEnabled(DeduplicationConstants.features.lazyDuplicatesPage)
