namespace Terrasoft.Configuration
{
	...
	public class ContractInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContractInFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContractInFolderEventsProcessSchema() {
			var schema = new ContractInFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContractInFolderEventsProcessSchema

	/// <exclude/>
	public class ContractInFolderEventsProcessSchema : Terrasoft.Configuration.BaseItemInFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ContractInFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContractInFolderEventsProcessSchema(ContractInFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContractInFolder_CoreContractsEventsProcess";
			UId = new Guid("92d583c3-17ac-43e9-93a6-937c233b579e");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ContractInFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("92d583c3-17ac-43e9-93a6-937c233b579e"));
		}
