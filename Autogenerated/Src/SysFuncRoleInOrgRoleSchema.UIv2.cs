namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysFuncRoleInOrgRole_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysFuncRoleInOrgRole
	{
