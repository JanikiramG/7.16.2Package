namespace Terrasoft.Configuration
{
	...
	public class SysAdminUnitFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysAdminUnitFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysAdminUnitFolderEventsProcessSchema() {
			var schema = new SysAdminUnitFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysAdminUnitFolderEventsProcessSchema

	/// <exclude/>
	public class SysAdminUnitFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public SysAdminUnitFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysAdminUnitFolderEventsProcessSchema(SysAdminUnitFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysAdminUnitFolder_BaseEventsProcess";
			UId = new Guid("f4b5a912-453e-49f4-acd8-6a2b30f4fca2");
			CreatedInPackageId = new Guid("76eace8e-4a48-486b-bf04-de18fe06b0a2");
		...
		public override object Clone() {
			return new SysAdminUnitFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f4b5a912-453e-49f4-acd8-6a2b30f4fca2"));
		}
