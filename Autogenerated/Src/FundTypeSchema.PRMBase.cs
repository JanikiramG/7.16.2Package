namespace Terrasoft.Configuration
{
	...
	public class FundTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFundTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFundTypeEventsProcessSchema() {
			var schema = new FundTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: FundTypeEventsProcessSchema

	/// <exclude/>
	public class FundTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public FundTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FundTypeEventsProcessSchema(FundTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FundType_PRMBaseEventsProcess";
			UId = new Guid("a9351418-2310-4152-8cf2-404147a0d1f9");
			CreatedInPackageId = new Guid("867b9a25-86bf-4a3e-8ecd-b6e40f57be82");
		...
		public override object Clone() {
			return new FundTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a9351418-2310-4152-8cf2-404147a0d1f9"));
		}
