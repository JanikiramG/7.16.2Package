namespace Terrasoft.Configuration
{
	...
	public class CommunicationSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCommunicationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCommunicationEventsProcessSchema() {
			var schema = new CommunicationEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CommunicationEventsProcessSchema

	/// <exclude/>
	public class CommunicationEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public CommunicationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CommunicationEventsProcessSchema(CommunicationEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new CommunicationEventsProcessSchema(this);
		}
