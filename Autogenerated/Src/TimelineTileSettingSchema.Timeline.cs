namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TimelineTileSetting_TimelineEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : TimelineTileSetting
	{
