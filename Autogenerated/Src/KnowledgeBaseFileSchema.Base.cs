namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBaseFileEventsProcessSchema();
		}
	...
	#region Class: KnowledgeBaseFileEventsProcessSchema

	/// <exclude/>
	public class KnowledgeBaseFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBaseFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public KnowledgeBaseFileEventsProcessSchema(KnowledgeBaseFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBaseFile_BaseEventsProcess";
			UId = new Guid("cdee85d8-8972-4d86-abd9-0d8532b97341");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new KnowledgeBaseFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("cdee85d8-8972-4d86-abd9-0d8532b97341"));
		}
