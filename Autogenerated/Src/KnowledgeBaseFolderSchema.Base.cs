namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBaseFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateKnowledgeBaseFolderEventsProcessSchema() {
			var schema = new KnowledgeBaseFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: KnowledgeBaseFolderEventsProcessSchema

	/// <exclude/>
	public class KnowledgeBaseFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBaseFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public KnowledgeBaseFolderEventsProcessSchema(KnowledgeBaseFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBaseFolder_BaseEventsProcess";
			UId = new Guid("842adeb7-91eb-4c13-b401-5c36f12e7f4e");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new KnowledgeBaseFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("842adeb7-91eb-4c13-b401-5c36f12e7f4e"));
		}
