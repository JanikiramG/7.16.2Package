namespace Terrasoft.Configuration
{
	...
	public class WebServiceV2TagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateWebServiceV2TagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateWebServiceV2TagEventsProcessSchema() {
			var schema = new WebServiceV2TagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: WebServiceV2TagEventsProcessSchema

	/// <exclude/>
	public class WebServiceV2TagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public WebServiceV2TagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public WebServiceV2TagEventsProcessSchema(WebServiceV2TagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "WebServiceV2Tag_ServiceDesignerEventsProcess";
			UId = new Guid("1d7c27b5-685a-4f27-b615-c900f7d82a8c");
			CreatedInPackageId = new Guid("9a41e39e-51c2-4a16-b81f-aa6773013744");
		...
		public override object Clone() {
			return new WebServiceV2TagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("1d7c27b5-685a-4f27-b615-c900f7d82a8c"));
		}
