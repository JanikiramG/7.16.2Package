namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentDelay_Passport_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentDelay_Passport_TerrasoftEventsProcessSchema();
		}
	...
	#region Class: SupplyPaymentDelay_Passport_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentDelay_Passport_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentDelay_Passport_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SupplyPaymentDelay_PassportEventsProcess";
			UId = new Guid("09325939-9f02-4a15-af5a-e509fad57c31");
			CreatedInPackageId = new Guid("f50b1877-37f3-4844-90b8-f493542cdd8d");
		...
		public override object Clone() {
			return new SupplyPaymentDelay_Passport_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("09325939-9f02-4a15-af5a-e509fad57c31"));
		}
