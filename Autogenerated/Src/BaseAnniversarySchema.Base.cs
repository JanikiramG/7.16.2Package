namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseAnniversary_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : BaseAnniversary
	{
