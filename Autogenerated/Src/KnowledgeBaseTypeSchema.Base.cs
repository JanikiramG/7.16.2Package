namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBaseTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBaseTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateKnowledgeBaseTypeEventsProcessSchema() {
			var schema = new KnowledgeBaseTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: KnowledgeBaseTypeEventsProcessSchema

	/// <exclude/>
	public class KnowledgeBaseTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBaseTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public KnowledgeBaseTypeEventsProcessSchema(KnowledgeBaseTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBaseType_BaseEventsProcess";
			UId = new Guid("430c4826-c1fd-4e1c-a66b-dd6b77c9728b");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new KnowledgeBaseTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("430c4826-c1fd-4e1c-a66b-dd6b77c9728b"));
		}
