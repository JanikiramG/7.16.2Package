namespace Terrasoft.Configuration
{
	...
	public class KnowledgeBase_SspKnowledgeBase_TerrasoftSchema : Terrasoft.Configuration.KnowledgeBase_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema();
		}
	...
	#region Class: KnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class KnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema : Terrasoft.Configuration.KnowledgeBase_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBase_SspKnowledgeBaseEventsProcess";
			UId = new Guid("53126477-4145-45ed-9c15-3a820acdbb0a");
			CreatedInPackageId = new Guid("5a28efb4-0330-4d41-a77d-4203b6bbc0a9");
		...
		public override object Clone() {
			return new KnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("53126477-4145-45ed-9c15-3a820acdbb0a"));
		}
