namespace Terrasoft.Configuration
{
	...
	public class BufferedImportEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBufferedImportEntityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBufferedImportEntityEventsProcessSchema() {
			var schema = new BufferedImportEntityEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class BufferedImportEntity_FileImportEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : BufferedImportEntity
	{
	...
	#region Class: BufferedImportEntityEventsProcessSchema

	/// <exclude/>
	public class BufferedImportEntityEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public BufferedImportEntityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BufferedImportEntityEventsProcessSchema(BufferedImportEntityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "BufferedImportEntity_FileImportEventsProcess";
			UId = new Guid("b72bee92-900a-44d4-a854-88e7e77b6645");
			CreatedInPackageId = new Guid("b51eda84-5cfb-4f7f-b7eb-7f869b20e7e8");
		...
		public override object Clone() {
			return new BufferedImportEntityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b72bee92-900a-44d4-a854-88e7e77b6645"));
		}
