...
namespace  Terrasoft.UI.WebControls.Utilities.Json.Converters
{
	...
	{
		public ProcessDataSourceFiltersJsonConverter(UserConnection userConnection, EntitySchema entitySchema, ProcessActivity processActivity)
			: base(userConnection, entitySchema, processActivity) { }
	}
...
#region CRM-42476 Адаптировать Terrasoft.Sync
