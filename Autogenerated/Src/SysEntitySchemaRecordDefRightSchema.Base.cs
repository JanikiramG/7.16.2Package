namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysEntitySchemaRecordDefRight_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysEntitySchemaRecordDefRight
	{
