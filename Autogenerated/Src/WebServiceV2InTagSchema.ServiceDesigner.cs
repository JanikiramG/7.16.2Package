namespace Terrasoft.Configuration
{
	...
	public class WebServiceV2InTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateWebServiceV2InTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateWebServiceV2InTagEventsProcessSchema() {
			var schema = new WebServiceV2InTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: WebServiceV2InTagEventsProcessSchema

	/// <exclude/>
	public class WebServiceV2InTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public WebServiceV2InTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public WebServiceV2InTagEventsProcessSchema(WebServiceV2InTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "WebServiceV2InTag_ServiceDesignerEventsProcess";
			UId = new Guid("e752784c-cea7-4db0-8921-f127c6bf154b");
			CreatedInPackageId = new Guid("9a41e39e-51c2-4a16-b81f-aa6773013744");
		...
		public override object Clone() {
			return new WebServiceV2InTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e752784c-cea7-4db0-8921-f127c6bf154b"));
		}
