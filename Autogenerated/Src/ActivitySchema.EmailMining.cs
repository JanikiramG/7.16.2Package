namespace Terrasoft.Configuration
{
	...
	public class Activity_EmailMining_TerrasoftSchema : Terrasoft.Configuration.Activity_Exchange_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivity_EmailMining_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivity_EmailMining_TerrasoftEventsProcessSchema() {
			var schema = new Activity_EmailMining_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: Activity_EmailMining_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Activity_EmailMining_TerrasoftEventsProcessSchema : Terrasoft.Configuration.Activity_Exchange_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public Activity_EmailMining_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Activity_EmailMining_TerrasoftEventsProcessSchema(Activity_EmailMining_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Activity_EmailMiningEventsProcess";
			UId = new Guid("9b349afc-f685-4df4-8bab-680d6ca9d386");
			CreatedInPackageId = new Guid("c1529436-dee9-4290-84f1-87386440a2b1");
		...
		public override object Clone() {
			return new Activity_EmailMining_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9b349afc-f685-4df4-8bab-680d6ca9d386"));
		}
