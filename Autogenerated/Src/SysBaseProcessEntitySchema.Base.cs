namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysBaseProcessEntity_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysBaseProcessEntity
	{
