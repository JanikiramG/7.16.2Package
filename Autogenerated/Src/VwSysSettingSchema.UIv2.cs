namespace Terrasoft.Configuration
{
	...
	public class VwSysSettingSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSysSettingEventsProcessSchema();
		}
	...
	#region Class: VwSysSettingEventsProcessSchema

	/// <exclude/>
	public class VwSysSettingEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwSysSettingEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSysSetting_UIv2EventsProcess";
			UId = new Guid("d5780a3a-10be-4e5f-ad99-92c0a4784aa2");
			CreatedInPackageId = new Guid("fc707408-e226-4f6e-ba83-43c0cf93ebc1");
		...
		public override object Clone() {
			return new VwSysSettingEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("d5780a3a-10be-4e5f-ad99-92c0a4784aa2"));
		}
