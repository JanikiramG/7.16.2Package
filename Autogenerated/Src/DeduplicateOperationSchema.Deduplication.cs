namespace Terrasoft.Configuration
{
	...
	public class DeduplicateOperationSchema : Terrasoft.Configuration.LookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDeduplicateOperationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDeduplicateOperationEventsProcessSchema() {
			var schema = new DeduplicateOperationEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DeduplicateOperationEventsProcessSchema

	/// <exclude/>
	public class DeduplicateOperationEventsProcessSchema : Terrasoft.Configuration.LookupEventsProcessSchema
	{

		#region Constructors: Public

		public DeduplicateOperationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DeduplicateOperationEventsProcessSchema(DeduplicateOperationEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DeduplicateOperation_DeduplicationEventsProcess";
			UId = new Guid("4ef5eff2-a34b-4efb-99f6-73f7e3dae0a2");
			CreatedInPackageId = new Guid("a2cb4b0a-72d7-4fbf-b57c-bc3bae7898e7");
		...
		public override object Clone() {
			return new DeduplicateOperationEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4ef5eff2-a34b-4efb-99f6-73f7e3dae0a2"));
		}
