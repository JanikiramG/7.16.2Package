namespace Terrasoft.Configuration
{
	...
	public class ContactSalutationType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContactSalutationType_Base_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContactSalutationType_Base_TerrasoftEventsProcessSchema() {
			var schema = new ContactSalutationType_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContactSalutationType_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class ContactSalutationType_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ContactSalutationType_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContactSalutationType_Base_TerrasoftEventsProcessSchema(ContactSalutationType_Base_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactSalutationType_BaseEventsProcess";
			UId = new Guid("6c9d2006-fb54-4953-bb20-0d05a79b0321");
		...
		public override object Clone() {
			return new ContactSalutationType_Base_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("6c9d2006-fb54-4953-bb20-0d05a79b0321"));
		}
