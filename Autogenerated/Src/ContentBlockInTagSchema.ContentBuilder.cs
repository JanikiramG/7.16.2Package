namespace Terrasoft.Configuration
{
	...
	public class ContentBlockInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContentBlockInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContentBlockInTagEventsProcessSchema() {
			var schema = new ContentBlockInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContentBlockInTagEventsProcessSchema

	/// <exclude/>
	public class ContentBlockInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ContentBlockInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContentBlockInTagEventsProcessSchema(ContentBlockInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContentBlockInTag_ContentBuilderEventsProcess";
			UId = new Guid("fb4c2edf-af88-4429-aa99-148e92f27df7");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ContentBlockInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("fb4c2edf-af88-4429-aa99-148e92f27df7"));
		}
