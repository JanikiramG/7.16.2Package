namespace Terrasoft.Configuration
{
	...
	public class SynchronizationProcessStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSynchronizationProcessStateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSynchronizationProcessStateEventsProcessSchema() {
			var schema = new SynchronizationProcessStateEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SynchronizationProcessStateEventsProcessSchema

	/// <exclude/>
	public class SynchronizationProcessStateEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SynchronizationProcessStateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SynchronizationProcessStateEventsProcessSchema(SynchronizationProcessStateEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SynchronizationProcessState_BaseEventsProcess";
			UId = new Guid("174156d8-065a-4f22-9b2a-e94a66c96140");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SynchronizationProcessStateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("174156d8-065a-4f22-9b2a-e94a66c96140"));
		}
