namespace Terrasoft.Configuration
{
	...
	public class EmailTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEmailTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEmailTypeEventsProcessSchema() {
			var schema = new EmailTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EmailTypeEventsProcessSchema

	/// <exclude/>
	public class EmailTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EmailTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EmailTypeEventsProcessSchema(EmailTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EmailType_BaseEventsProcess";
			UId = new Guid("f22868dd-67a3-4000-af65-59a000140fe5");
		...
		public override object Clone() {
			return new EmailTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f22868dd-67a3-4000-af65-59a000140fe5"));
		}
