namespace Terrasoft.Configuration
{
	...
	public class OpportunityParticipantRoleSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityParticipantRoleEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityParticipantRoleEventsProcessSchema() {
			var schema = new OpportunityParticipantRoleEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityParticipantRoleEventsProcessSchema

	/// <exclude/>
	public class OpportunityParticipantRoleEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityParticipantRoleEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityParticipantRoleEventsProcessSchema(OpportunityParticipantRoleEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityParticipantRole_OpportunityEventsProcess";
			UId = new Guid("a8ce0721-e2c4-4676-a666-44fd55730981");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new OpportunityParticipantRoleEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a8ce0721-e2c4-4676-a666-44fd55730981"));
		}
