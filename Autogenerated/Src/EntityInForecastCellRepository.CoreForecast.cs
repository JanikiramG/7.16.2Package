namespace Terrasoft.Configuration.ForecastV2
{
	...
	public interface IForecastCellRepository : IEntityInForecastCellRepository
	{
		/// <summary>
		/// Saves the cell.
		/// </summary>
		...
		/// </summary>
		/// <param name="forecastSheet">The forecast sheet.</param>
		/// <param name="forecastShperiodseet">Periods.</param>
	...
	public class EntityInForecastCellRepository : IForecastCellRepository
	{
		...
		public IEnumerable<Cell> GetCellsByRecords(Sheet forecastSheet, IEnumerable<Guid> periodIds,
			...
			recordIds.CheckArgumentNull(nameof(recordIds));
			var esq = GetCellsESQ(forecastSheet, periodIds);
			esq.Filters.Add(esq.CreateFilterWithParameters(FilterComparisonType.Equal,
