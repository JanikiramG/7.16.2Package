namespace Terrasoft.Configuration
{
	...
	public class LookupTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLookupTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLookupTagEventsProcessSchema() {
			var schema = new LookupTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LookupTagEventsProcessSchema

	/// <exclude/>
	public class LookupTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public LookupTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LookupTagEventsProcessSchema(LookupTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LookupTag_BaseEventsProcess";
			UId = new Guid("143045af-c8f4-4586-8b27-9bda3352737f");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new LookupTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("143045af-c8f4-4586-8b27-9bda3352737f"));
		}
