namespace Terrasoft.Configuration
{
	...
	public class IntegrationLogSettingsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateIntegrationLogSettingsEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateIntegrationLogSettingsEventsProcessSchema() {
			var schema = new IntegrationLogSettingsEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class IntegrationLogSettings_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : IntegrationLogSettings
	{
	...
	#region Class: IntegrationLogSettingsEventsProcessSchema

	/// <exclude/>
	public class IntegrationLogSettingsEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public IntegrationLogSettingsEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public IntegrationLogSettingsEventsProcessSchema(IntegrationLogSettingsEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "IntegrationLogSettings_BaseEventsProcess";
			UId = new Guid("a30f881f-17d1-446c-859e-5034265a12ea");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new IntegrationLogSettingsEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a30f881f-17d1-446c-859e-5034265a12ea"));
		}
