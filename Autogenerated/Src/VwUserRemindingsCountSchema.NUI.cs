namespace Terrasoft.Configuration
{
	...
	public class VwUserRemindingsCountSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwUserRemindingsCountEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwUserRemindingsCountEventsProcessSchema() {
			var schema = new VwUserRemindingsCountEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwUserRemindingsCountEventsProcessSchema

	/// <exclude/>
	public class VwUserRemindingsCountEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwUserRemindingsCountEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwUserRemindingsCountEventsProcessSchema(VwUserRemindingsCountEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwUserRemindingsCount_NUIEventsProcess";
			UId = new Guid("f5f16bb4-1b8e-44ff-95a3-7b3b07661882");
			CreatedInPackageId = new Guid("9ad95375-5845-4ea4-b0ef-1ad3d23bf529");
		...
		public override object Clone() {
			return new VwUserRemindingsCountEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f5f16bb4-1b8e-44ff-95a3-7b3b07661882"));
		}
