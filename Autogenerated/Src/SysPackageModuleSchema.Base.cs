namespace Terrasoft.Configuration
{
	...
	public class SysPackageModuleSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysPackageModule_BaseEventsProcess(userConnection);
		}
	...
	public class SysPackageModule : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysPackageModuleDeleted", e);
	...
	/// <exclude/>
	public partial class SysPackageModule_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : SysPackageModule
	{
	...
	public partial class SysPackageModule_BaseEventsProcess<TEntity>
	{
