namespace Terrasoft.Configuration
{
	...
	public class ResolvedLookupConflictSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateResolvedLookupConflictEventsProcessSchema();
		}
	...
	/// <exclude/>
	public partial class ResolvedLookupConflict_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ResolvedLookupConflict
	{
	...
	#region Class: ResolvedLookupConflictEventsProcessSchema

	/// <exclude/>
	public class ResolvedLookupConflictEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public ResolvedLookupConflictEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ResolvedLookupConflictEventsProcessSchema(ResolvedLookupConflictEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ResolvedLookupConflict_BaseEventsProcess";
			UId = new Guid("b7c6a157-344b-4898-a269-b925a29c605e");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ResolvedLookupConflictEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b7c6a157-344b-4898-a269-b925a29c605e"));
		}
