namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EntityTypeLookup_UIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : EntityTypeLookup
	{
