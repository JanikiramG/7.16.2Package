namespace Terrasoft.Configuration
{
	...
	public class VwOAuthAppUserSchema : Terrasoft.Configuration.OAuthTokenStorageSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwOAuthAppUserEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwOAuthAppUserEventsProcessSchema() {
			var schema = new VwOAuthAppUserEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwOAuthAppUserEventsProcessSchema

	/// <exclude/>
	public class VwOAuthAppUserEventsProcessSchema : Terrasoft.Configuration.OAuthTokenStorageEventsProcessSchema
	{

		#region Constructors: Public

		public VwOAuthAppUserEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwOAuthAppUserEventsProcessSchema(VwOAuthAppUserEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwOAuthAppUser_OAuth20IntegrationEventsProcess";
			UId = new Guid("537b343a-0850-4dd1-96cf-86fb5acff7a0");
			CreatedInPackageId = new Guid("69832cb9-4518-407d-8490-ad1baa6b0193");
			...
			ParentSchemaUId = new Guid("6c2d0481-4e35-42c5-b276-15895ed56ce6");
		...
		public override object Clone() {
			return new VwOAuthAppUserEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("537b343a-0850-4dd1-96cf-86fb5acff7a0"));
		}
