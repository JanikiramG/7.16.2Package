namespace Terrasoft.Configuration
{
	...
	public class ProductType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductType_Base_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductType_Base_TerrasoftEventsProcessSchema() {
			var schema = new ProductType_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProductType_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class ProductType_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ProductType_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductType_Base_TerrasoftEventsProcessSchema(ProductType_Base_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductType_BaseEventsProcess";
			UId = new Guid("a18f710f-c28c-4216-b13c-6bd5b10b0feb");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ProductType_Base_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a18f710f-c28c-4216-b13c-6bd5b10b0feb"));
		}
