namespace Terrasoft.Configuration
{
	...
	public class VwInvoiceProductSchema : Terrasoft.Configuration.InvoiceProductSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwInvoiceProductEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwInvoiceProductEventsProcessSchema() {
			var schema = new VwInvoiceProductEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwInvoiceProductEventsProcessSchema

	/// <exclude/>
	public class VwInvoiceProductEventsProcessSchema : Terrasoft.Configuration.InvoiceProductEventsProcessSchema
	{

		#region Constructors: Public

		public VwInvoiceProductEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwInvoiceProductEventsProcessSchema(VwInvoiceProductEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwInvoiceProduct_InvoiceEventsProcess";
			UId = new Guid("449ff586-b5c9-43be-a75f-1eda0e3f729a");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new VwInvoiceProductEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("449ff586-b5c9-43be-a75f-1eda0e3f729a"));
		}
