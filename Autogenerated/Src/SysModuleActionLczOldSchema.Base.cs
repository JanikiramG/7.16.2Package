namespace Terrasoft.Configuration
{
	...
	public class SysModuleActionLczOldSchema : Terrasoft.Configuration.BaseLczEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysModuleActionLczOldEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysModuleActionLczOldEventsProcessSchema() {
			var schema = new SysModuleActionLczOldEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysModuleActionLczOldEventsProcessSchema

	/// <exclude/>
	public class SysModuleActionLczOldEventsProcessSchema : Terrasoft.Configuration.BaseLczEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysModuleActionLczOldEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysModuleActionLczOldEventsProcessSchema(SysModuleActionLczOldEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysModuleActionLczOld_BaseEventsProcess";
			UId = new Guid("60ea8696-7f31-4fc2-9757-3902735f95cb");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysModuleActionLczOldEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("60ea8696-7f31-4fc2-9757-3902735f95cb"));
		}
