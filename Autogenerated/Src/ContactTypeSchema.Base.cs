namespace Terrasoft.Configuration
{
	...
	public class ContactTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContactTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContactTypeEventsProcessSchema() {
			var schema = new ContactTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContactTypeEventsProcessSchema

	/// <exclude/>
	public class ContactTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ContactTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContactTypeEventsProcessSchema(ContactTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactType_BaseEventsProcess";
			UId = new Guid("9f0a80f7-8e35-4af9-9c02-2d6606c5ed7c");
		...
		public override object Clone() {
			return new ContactTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9f0a80f7-8e35-4af9-9c02-2d6606c5ed7c"));
		}
