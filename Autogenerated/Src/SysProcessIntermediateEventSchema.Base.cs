namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysProcessIntermediateEvent_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysProcessIntermediateEvent
	{
