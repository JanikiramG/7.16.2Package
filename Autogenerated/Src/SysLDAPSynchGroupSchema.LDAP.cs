namespace Terrasoft.Configuration
{
	...
	public class SysLDAPSynchGroupSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysLDAPSynchGroupEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysLDAPSynchGroupEventsProcessSchema() {
			var schema = new SysLDAPSynchGroupEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysLDAPSynchGroupEventsProcessSchema

	/// <exclude/>
	public class SysLDAPSynchGroupEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public SysLDAPSynchGroupEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysLDAPSynchGroupEventsProcessSchema(SysLDAPSynchGroupEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysLDAPSynchGroup_LDAPEventsProcess";
			UId = new Guid("5ee977dc-e447-4b06-86d6-509ce32e5292");
			CreatedInPackageId = new Guid("69e4f6ff-abe4-4817-965a-3167843360f4");
		...
		public override object Clone() {
			return new SysLDAPSynchGroupEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5ee977dc-e447-4b06-86d6-509ce32e5292"));
		}
