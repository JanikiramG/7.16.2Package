namespace Terrasoft.Configuration
{
	...
	public class LeadSource_Lead_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new LeadSource_LeadEventsProcess(userConnection);
		}
	...
	public class LeadSource_Lead_Terrasoft : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("LeadSource_Lead_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class LeadSource_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadSource_Lead_Terrasoft
	{
	...
	public partial class LeadSource_LeadEventsProcess<TEntity>
	{
