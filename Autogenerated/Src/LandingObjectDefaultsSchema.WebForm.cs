namespace Terrasoft.Configuration
{
	...
	public class LandingObjectDefaultsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLandingObjectDefaultsEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLandingObjectDefaultsEventsProcessSchema() {
			var schema = new LandingObjectDefaultsEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class LandingObjectDefaults_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : LandingObjectDefaults
	{
	...
	#region Class: LandingObjectDefaultsEventsProcessSchema

	/// <exclude/>
	public class LandingObjectDefaultsEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public LandingObjectDefaultsEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LandingObjectDefaultsEventsProcessSchema(LandingObjectDefaultsEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LandingObjectDefaults_WebFormEventsProcess";
			UId = new Guid("c06479f8-1bf0-4ecc-926c-5e9c039c3f09");
			CreatedInPackageId = new Guid("9d05c8ee-17e3-41aa-adfe-7e36f0a4c27c");
		...
		public override object Clone() {
			return new LandingObjectDefaultsEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c06479f8-1bf0-4ecc-926c-5e9c039c3f09"));
		}
