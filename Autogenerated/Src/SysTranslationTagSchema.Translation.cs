namespace Terrasoft.Configuration
{
	...
	public class SysTranslationTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysTranslationTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysTranslationTagEventsProcessSchema() {
			var schema = new SysTranslationTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysTranslationTagEventsProcessSchema

	/// <exclude/>
	public class SysTranslationTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public SysTranslationTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysTranslationTagEventsProcessSchema(SysTranslationTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysTranslationTag_TranslationEventsProcess";
			UId = new Guid("38d7c988-cf96-4ed0-898d-149aa880cbd5");
			CreatedInPackageId = new Guid("79d5e1e4-18af-4001-8dc1-26f09fca92c2");
		...
		public override object Clone() {
			return new SysTranslationTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("38d7c988-cf96-4ed0-898d-149aa880cbd5"));
		}
