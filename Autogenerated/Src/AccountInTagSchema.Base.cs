namespace Terrasoft.Configuration
{
	...
	public class AccountInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountInTagEventsProcessSchema() {
			var schema = new AccountInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountInTagEventsProcessSchema

	/// <exclude/>
	public class AccountInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public AccountInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountInTagEventsProcessSchema(AccountInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountInTag_BaseEventsProcess";
			UId = new Guid("e6924c88-31e5-4365-a1c8-b8cd7301d080");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new AccountInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e6924c88-31e5-4365-a1c8-b8cd7301d080"));
		}
