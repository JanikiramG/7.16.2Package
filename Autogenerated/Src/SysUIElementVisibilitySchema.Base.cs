namespace Terrasoft.Configuration
{
	...
	public class SysUIElementVisibilitySchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysUIElementVisibilityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysUIElementVisibilityEventsProcessSchema() {
			var schema = new SysUIElementVisibilityEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SysUIElementVisibilityEventsProcessSchema

	/// <exclude/>
	public class SysUIElementVisibilityEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysUIElementVisibilityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysUIElementVisibilityEventsProcessSchema(SysUIElementVisibilityEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new SysUIElementVisibilityEventsProcessSchema(this);
		}
