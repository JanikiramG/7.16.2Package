namespace Terrasoft.Configuration
{
	...
	public class IntegrationOperationSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateIntegrationOperationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateIntegrationOperationEventsProcessSchema() {
			var schema = new IntegrationOperationEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: IntegrationOperationEventsProcessSchema

	/// <exclude/>
	public class IntegrationOperationEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public IntegrationOperationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public IntegrationOperationEventsProcessSchema(IntegrationOperationEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "IntegrationOperation_BaseEventsProcess";
			UId = new Guid("4d37ecc8-775c-4378-9687-5238f66f1726");
		...
		public override object Clone() {
			return new IntegrationOperationEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("4d37ecc8-775c-4378-9687-5238f66f1726"));
		}
