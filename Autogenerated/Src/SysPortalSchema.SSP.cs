namespace Terrasoft.Configuration
{
	...
	public class SysPortalSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysPortalEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysPortalEventsProcessSchema() {
			var schema = new SysPortalEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysPortal_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysPortal
	{
	...
	#region Class: SysPortalEventsProcessSchema

	/// <exclude/>
	public class SysPortalEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysPortalEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysPortalEventsProcessSchema(SysPortalEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysPortal_SSPEventsProcess";
			UId = new Guid("822582c6-2819-47d2-addb-31a3749382df");
			CreatedInPackageId = new Guid("fc741efe-5ee7-42c9-8935-9d298f1913b5");
		...
		public override object Clone() {
			return new SysPortalEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("822582c6-2819-47d2-addb-31a3749382df"));
		}
