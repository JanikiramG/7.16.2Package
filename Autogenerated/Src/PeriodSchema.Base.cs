namespace Terrasoft.Configuration
{
	...
	public class PeriodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePeriodEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePeriodEventsProcessSchema() {
			var schema = new PeriodEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PeriodEventsProcessSchema

	/// <exclude/>
	public class PeriodEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public PeriodEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PeriodEventsProcessSchema(PeriodEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Period_BaseEventsProcess";
			UId = new Guid("7c2b62aa-13db-4ad8-b27b-d42ebbacc4f3");
			CreatedInPackageId = new Guid("bb5b13b5-8833-41e4-a262-01f88b33e376");
		...
		public override object Clone() {
			return new PeriodEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7c2b62aa-13db-4ad8-b27b-d42ebbacc4f3"));
		}
