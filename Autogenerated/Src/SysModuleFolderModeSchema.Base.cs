namespace Terrasoft.Configuration
{
	...
	public class SysModuleFolderModeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysModuleFolderModeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysModuleFolderModeEventsProcessSchema() {
			var schema = new SysModuleFolderModeEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysModuleFolderMode_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleFolderMode
	{
	...
	#region Class: SysModuleFolderModeEventsProcessSchema

	/// <exclude/>
	public class SysModuleFolderModeEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysModuleFolderModeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysModuleFolderModeEventsProcessSchema(SysModuleFolderModeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysModuleFolderMode_BaseEventsProcess";
			UId = new Guid("9e0b1f30-cac0-47c8-b304-452b32112815");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysModuleFolderModeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9e0b1f30-cac0-47c8-b304-452b32112815"));
		}
