namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class PushNotificationService_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : PushNotificationService
	{
