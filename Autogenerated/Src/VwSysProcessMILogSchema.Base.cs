namespace Terrasoft.Configuration
{
	...
	public class VwSysProcessMILogSchema : Terrasoft.Configuration.VwSysProcessLogSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSysProcessMILogEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSysProcessMILogEventsProcessSchema() {
			var schema = new VwSysProcessMILogEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSysProcessMILogEventsProcessSchema

	/// <exclude/>
	public class VwSysProcessMILogEventsProcessSchema : Terrasoft.Configuration.VwSysProcessLogEventsProcessSchema
	{

		#region Constructors: Public

		public VwSysProcessMILogEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSysProcessMILogEventsProcessSchema(VwSysProcessMILogEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSysProcessMILog_BaseEventsProcess";
			UId = new Guid("e8ba2ea9-ab64-43ee-bc5a-c85f162e25d2");
			CreatedInPackageId = new Guid("3c624d29-361c-47f2-ac8f-7824eb3cde6f");
			...
			ParentSchemaUId = new Guid("9b9f1b7b-d121-4ac2-aa4d-f6b49086ba8b");
		...
		public override object Clone() {
			return new VwSysProcessMILogEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e8ba2ea9-ab64-43ee-bc5a-c85f162e25d2"));
		}
