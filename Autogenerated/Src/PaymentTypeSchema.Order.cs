namespace Terrasoft.Configuration
{
	...
	public class PaymentTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreatePaymentTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreatePaymentTypeEventsProcessSchema() {
			var schema = new PaymentTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: PaymentTypeEventsProcessSchema

	/// <exclude/>
	public class PaymentTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public PaymentTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public PaymentTypeEventsProcessSchema(PaymentTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "PaymentType_OrderEventsProcess";
			UId = new Guid("51a56551-2fe3-452f-80ad-6370fef752b4");
			CreatedInPackageId = new Guid("dc9b0a8f-3f62-409f-a803-948a13d96822");
		...
		public override object Clone() {
			return new PaymentTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("51a56551-2fe3-452f-80ad-6370fef752b4"));
		}
