namespace Terrasoft.Configuration
{
	...
	public class EmployeeFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEmployeeFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEmployeeFileEventsProcessSchema() {
			var schema = new EmployeeFileEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EmployeeFileEventsProcessSchema

	/// <exclude/>
	public class EmployeeFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public EmployeeFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EmployeeFileEventsProcessSchema(EmployeeFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EmployeeFile_BaseEventsProcess";
			UId = new Guid("829dcc85-1d0c-4875-a4ac-4dfd3e60e531");
			CreatedInPackageId = new Guid("76eace8e-4a48-486b-bf04-de18fe06b0a2");
		...
		public override object Clone() {
			return new EmployeeFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("829dcc85-1d0c-4875-a4ac-4dfd3e60e531"));
		}
