namespace Terrasoft.Configuration
{
	...
	public class ProjectEntryTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProjectEntryTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProjectEntryTypeEventsProcessSchema() {
			var schema = new ProjectEntryTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ProjectEntryTypeEventsProcessSchema

	/// <exclude/>
	public class ProjectEntryTypeEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ProjectEntryTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProjectEntryTypeEventsProcessSchema(ProjectEntryTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProjectEntryType_ProjectEventsProcess";
			UId = new Guid("88a1cf66-bae9-46bb-96ee-c3da8727641d");
			CreatedInPackageId = new Guid("fe2bb0e4-061e-41b1-be85-5078c802043f");
		...
		public override object Clone() {
			return new ProjectEntryTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("88a1cf66-bae9-46bb-96ee-c3da8727641d"));
		}
