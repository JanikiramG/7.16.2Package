namespace Terrasoft.Configuration
{
	...
	public class WebServiceSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateWebServiceEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateWebServiceEventsProcessSchema() {
			var schema = new WebServiceEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: WebServiceEventsProcessSchema

	/// <exclude/>
	public class WebServiceEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public WebServiceEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public WebServiceEventsProcessSchema(WebServiceEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "WebService_ProcessDesignerEventsProcess";
			UId = new Guid("c71817d2-54d0-4804-906c-9507ba539303");
			CreatedInPackageId = new Guid("47c22e57-1b16-4004-8f6b-0f257046428b");
		...
		public override object Clone() {
			return new WebServiceEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c71817d2-54d0-4804-906c-9507ba539303"));
		}
