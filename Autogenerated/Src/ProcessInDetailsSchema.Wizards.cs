namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProcessInDetails_WizardsEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ProcessInDetails
	{
