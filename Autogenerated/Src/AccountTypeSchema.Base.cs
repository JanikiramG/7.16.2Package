namespace Terrasoft.Configuration
{
	...
	public class AccountType_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountType_Base_TerrasoftEventsProcessSchema();
		}
	...
	#region Class: AccountType_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class AccountType_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public AccountType_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountType_BaseEventsProcess";
			UId = new Guid("348a7891-ed13-4b5f-9e59-c18673ed63b1");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new AccountType_Base_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("348a7891-ed13-4b5f-9e59-c18673ed63b1"));
		}
