namespace Terrasoft.Configuration
{
	...
	public class ContactTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContactTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContactTagEventsProcessSchema() {
			var schema = new ContactTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContactTagEventsProcessSchema

	/// <exclude/>
	public class ContactTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ContactTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContactTagEventsProcessSchema(ContactTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactTag_BaseEventsProcess";
			UId = new Guid("b51c9b33-96b2-43b6-bb88-41d78933ab0e");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ContactTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b51c9b33-96b2-43b6-bb88-41d78933ab0e"));
		}
