namespace Terrasoft.Configuration
{
	...
	public class ExternalAccessFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateExternalAccessFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateExternalAccessFolderEventsProcessSchema() {
			var schema = new ExternalAccessFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ExternalAccessFolderEventsProcessSchema

	/// <exclude/>
	public class ExternalAccessFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public ExternalAccessFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ExternalAccessFolderEventsProcessSchema(ExternalAccessFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ExternalAccessFolder_ExternalAccessEventsProcess";
			UId = new Guid("ea401864-131a-4e97-a9e4-542253e0c5ee");
			CreatedInPackageId = new Guid("386ac9f6-07c1-4d11-8d16-e4e9424ba4e8");
		...
		public override object Clone() {
			return new ExternalAccessFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ea401864-131a-4e97-a9e4-542253e0c5ee"));
		}
