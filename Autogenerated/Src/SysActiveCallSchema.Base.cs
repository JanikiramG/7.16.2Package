namespace Terrasoft.Configuration
{
	...
	public class SysActiveCallSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysActiveCallEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysActiveCallEventsProcessSchema() {
			var schema = new SysActiveCallEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysActiveCall_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysActiveCall
	{
	...
	#region Class: SysActiveCallEventsProcessSchema

	/// <exclude/>
	public class SysActiveCallEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysActiveCallEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysActiveCallEventsProcessSchema(SysActiveCallEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysActiveCall_BaseEventsProcess";
			UId = new Guid("69d0b3e3-275a-405c-9f23-e2e044d67b12");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysActiveCallEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("69d0b3e3-275a-405c-9f23-e2e044d67b12"));
		}
