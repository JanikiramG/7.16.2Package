namespace Terrasoft.Configuration
{
	...
	public class LeadType_Lead_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new LeadType_LeadEventsProcess(userConnection);
		}
	...
	public class LeadType_Lead_Terrasoft : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("LeadType_Lead_TerrasoftDeleted", e);
	...
	/// <exclude/>
	public partial class LeadType_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_BaseEventsProcess<TEntity> where TEntity : LeadType_Lead_Terrasoft
	{
	...
	public partial class LeadType_LeadEventsProcess<TEntity>
	{
