namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleAnalyticsReport_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleAnalyticsReport
	{
