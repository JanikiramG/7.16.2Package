namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialMessageEntity_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SocialMessageEntity
	{
