namespace Terrasoft.Configuration
{
	...
	public class DocumentFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDocumentFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDocumentFileEventsProcessSchema() {
			var schema = new DocumentFileEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DocumentFileEventsProcessSchema

	/// <exclude/>
	public class DocumentFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public DocumentFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DocumentFileEventsProcessSchema(DocumentFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DocumentFile_DocumentEventsProcess";
			UId = new Guid("38ea6be7-1c51-484c-9bff-3a3a8591efdd");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new DocumentFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("38ea6be7-1c51-484c-9bff-3a3a8591efdd"));
		}
