namespace Terrasoft.Configuration
{
	...
	public class VwOrderProductFilterSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwOrderProductFilterEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwOrderProductFilterEventsProcessSchema() {
			var schema = new VwOrderProductFilterEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwOrderProductFilterEventsProcessSchema

	/// <exclude/>
	public class VwOrderProductFilterEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwOrderProductFilterEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwOrderProductFilterEventsProcessSchema(VwOrderProductFilterEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwOrderProductFilter_PassportEventsProcess";
			UId = new Guid("a9ea6e69-285f-4059-b312-c6024247d2ea");
			CreatedInPackageId = new Guid("c7111923-2c4e-4eb8-bedd-d31fcb8b2024");
		...
		public override object Clone() {
			return new VwOrderProductFilterEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a9ea6e69-285f-4059-b312-c6024247d2ea"));
		}
