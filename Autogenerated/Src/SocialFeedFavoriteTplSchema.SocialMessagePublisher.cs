namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialFeedFavoriteTpl_SocialMessagePublisherEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SocialFeedFavoriteTpl
	{
