namespace Terrasoft.Configuration
{
	...
	public class VwSspAdminUnitSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSspAdminUnitEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSspAdminUnitEventsProcessSchema() {
			var schema = new VwSspAdminUnitEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class VwSspAdminUnit_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwSspAdminUnit
	{
	...
	#region Class: VwSspAdminUnitEventsProcessSchema

	/// <exclude/>
	public class VwSspAdminUnitEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public VwSspAdminUnitEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSspAdminUnitEventsProcessSchema(VwSspAdminUnitEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSspAdminUnit_SSPEventsProcess";
			UId = new Guid("22513b5a-3d66-4bea-bdb6-242a870ddf93");
			CreatedInPackageId = new Guid("7cc31540-fa76-4c79-9b86-a6eabd8e662c");
		...
		public override object Clone() {
			return new VwSspAdminUnitEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("22513b5a-3d66-4bea-bdb6-242a870ddf93"));
		}
