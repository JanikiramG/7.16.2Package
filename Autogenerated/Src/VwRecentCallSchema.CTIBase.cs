namespace Terrasoft.Configuration
{
	...
	public class VwRecentCallSchema : Terrasoft.Core.Entities.EntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwRecentCallEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwRecentCallEventsProcessSchema() {
			var schema = new VwRecentCallEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwRecentCallEventsProcessSchema

	/// <exclude/>
	public class VwRecentCallEventsProcessSchema : Terrasoft.Core.Process.EmbeddedProcessSchema
	{

		#region Constructors: Public

		public VwRecentCallEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwRecentCallEventsProcessSchema(VwRecentCallEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwRecentCall_CTIBaseEventsProcess";
			UId = new Guid("3e8ecc4c-f52c-429f-b365-1840b9a98e35");
			CreatedInPackageId = new Guid("66721ee9-20ab-40fe-a9a1-3b668222939d");
		...
		public override object Clone() {
			return new VwRecentCallEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3e8ecc4c-f52c-429f-b365-1840b9a98e35"));
		}
