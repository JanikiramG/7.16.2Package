namespace Terrasoft.Configuration
{
	...
	public class Activity_Order_TerrasoftSchema : Terrasoft.Configuration.Activity_Project_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivity_Order_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivity_Order_TerrasoftEventsProcessSchema() {
			var schema = new Activity_Order_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: Activity_Order_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Activity_Order_TerrasoftEventsProcessSchema : Terrasoft.Configuration.Activity_Project_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public Activity_Order_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Activity_Order_TerrasoftEventsProcessSchema(Activity_Order_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Activity_OrderEventsProcess";
			UId = new Guid("ca317edb-ef4b-4726-9982-c618e8b26563");
			CreatedInPackageId = new Guid("11b832b1-75bb-4c0d-bb5d-5aa5088efe52");
		...
		public override object Clone() {
			return new Activity_Order_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ca317edb-ef4b-4726-9982-c618e8b26563"));
		}
