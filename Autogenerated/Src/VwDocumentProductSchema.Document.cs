namespace Terrasoft.Configuration
{
	...
	public class VwDocumentProductSchema : Terrasoft.Configuration.DocumentProductSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwDocumentProductEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwDocumentProductEventsProcessSchema() {
			var schema = new VwDocumentProductEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwDocumentProductEventsProcessSchema

	/// <exclude/>
	public class VwDocumentProductEventsProcessSchema : Terrasoft.Configuration.DocumentProductEventsProcessSchema
	{

		#region Constructors: Public

		public VwDocumentProductEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwDocumentProductEventsProcessSchema(VwDocumentProductEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwDocumentProduct_DocumentEventsProcess";
			UId = new Guid("7f6976b0-8d53-4854-b446-c24b54465640");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
			...
			ParentSchemaUId = new Guid("cb2f3647-e12d-4ab4-8b9d-62055d9b5f0a");
		...
		public override object Clone() {
			return new VwDocumentProductEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7f6976b0-8d53-4854-b446-c24b54465640"));
		}
