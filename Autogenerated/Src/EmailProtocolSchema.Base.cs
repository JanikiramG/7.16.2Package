namespace Terrasoft.Configuration
{
	...
	public class EmailProtocolSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEmailProtocolEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEmailProtocolEventsProcessSchema() {
			var schema = new EmailProtocolEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EmailProtocolEventsProcessSchema

	/// <exclude/>
	public class EmailProtocolEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EmailProtocolEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EmailProtocolEventsProcessSchema(EmailProtocolEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EmailProtocol_BaseEventsProcess";
			UId = new Guid("c5c4fe82-d3a2-41f1-9abb-4e957e129247");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new EmailProtocolEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("c5c4fe82-d3a2-41f1-9abb-4e957e129247"));
		}
