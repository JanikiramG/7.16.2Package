	...
	return {
		...
		methods: {
			...
			*/
			...
			/**
			 * Creates a filter group for receiving only personal licensing packages.
			 * @protected
			 * @return {Terrasoft.FilterGroup}
			 */
			createPersonalLicPackageFilterGroup: function() {
				...
				filters.addItem(this.Terrasoft.createColumnFilterWithParameter(this.Terrasoft.ComparisonType.EQUAL,
					"[SysLic:SysLicPackage:Id].LicType", 0));
				filters.addItem(this.Terrasoft.createColumnFilterWithParameter(this.Terrasoft.ComparisonType.NOT_CONTAIN,
					"Operations", "IsServerLicPackage"));
				return filters;
			},
			...
			getLicRecallLookupConfig: function(licPackageIds) {
				var filters;
				if (licPackageIds.length > 0) {
					filters = this.createPersonalLicPackageFilterGroup();
					filters.addItem(this.Terrasoft.createColumnInFilterWithParameters("Id", licPackageIds));
				} else {
					filters = this.Terrasoft.createColumnIsNullFilter("Id");
				}
				return {
					entitySchemaName: "SysLicPackage",
					multiSelect: true,
