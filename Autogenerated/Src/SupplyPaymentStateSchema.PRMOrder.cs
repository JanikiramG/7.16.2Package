namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentStateSchema : Terrasoft.Configuration.SupplyPaymentState_Passport_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentStateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSupplyPaymentStateEventsProcessSchema() {
			var schema = new SupplyPaymentStateEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SupplyPaymentStateEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentStateEventsProcessSchema : Terrasoft.Configuration.SupplyPaymentState_Passport_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentStateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SupplyPaymentStateEventsProcessSchema(SupplyPaymentStateEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SupplyPaymentState_PRMOrderEventsProcess";
			UId = new Guid("9a94caa3-c217-4614-8125-5f9a37c90ecc");
			CreatedInPackageId = new Guid("f50b1877-37f3-4844-90b8-f493542cdd8d");
		...
		public override object Clone() {
			return new SupplyPaymentStateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9a94caa3-c217-4614-8125-5f9a37c90ecc"));
		}
