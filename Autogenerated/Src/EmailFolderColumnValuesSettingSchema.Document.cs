namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class EmailFolderColumnValuesSettingEventsProcessSchema : Terrasoft.Configuration.EmailFolderColumnValuesSetting_Invoice_TerrasoftEventsProcessSchema
	{
