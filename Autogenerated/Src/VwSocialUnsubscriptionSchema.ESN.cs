namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSocialUnsubscription_ESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwSocialUnsubscription
	{
