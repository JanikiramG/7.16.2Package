namespace Terrasoft.Configuration
{
	...
	public class JobSchema : Terrasoft.Configuration.Job_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateJobEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateJobEventsProcessSchema() {
			var schema = new JobEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: JobEventsProcessSchema

	/// <exclude/>
	public class JobEventsProcessSchema : Terrasoft.Configuration.Job_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public JobEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public JobEventsProcessSchema(JobEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Job_SSPEventsProcess";
			UId = new Guid("bc90ca65-2dea-4b88-aea4-4aa0472abdb6");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("92f83f9c-f333-4f92-a44b-1b0d1a965235");
		...
		public override object Clone() {
			return new JobEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("bc90ca65-2dea-4b88-aea4-4aa0472abdb6"));
		}
