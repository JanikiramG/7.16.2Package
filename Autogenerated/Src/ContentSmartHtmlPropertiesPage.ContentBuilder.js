			...
			createMacroListItemViewModel: function(macro) {
				...
				switch (macro.DataValueType) {
					case Terrasoft.DataValueType.LONG_TEXT:
						listItemViewModel = new Terrasoft.TextMacroListItemViewModel({values: macro});
						break;
					case Terrasoft.DataValueType.COLOR:
						listItemViewModel = new Terrasoft.ColorMacroListItemViewModel({values: macro});
						break;
					case Terrasoft.DataValueType.IMAGE:
						listItemViewModel = new Terrasoft.ImageMacroListItemViewModel({values: macro});
						break;
					default:
						listItemViewModel = new Terrasoft.BaseMacroListItemViewModel({values: macro});
				}
