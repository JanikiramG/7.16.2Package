namespace Terrasoft.Configuration
{
	...
	public class SysOrderDirectionSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysOrderDirectionEventsProcessSchema();
		}
	...
	#region Class: SysOrderDirectionEventsProcessSchema

	/// <exclude/>
	public class SysOrderDirectionEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SysOrderDirectionEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		public override object Clone() {
			return new SysOrderDirectionEventsProcessSchema(this);
		}
