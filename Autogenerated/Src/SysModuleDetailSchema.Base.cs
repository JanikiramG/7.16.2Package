namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleDetail_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysModuleDetail
	{
