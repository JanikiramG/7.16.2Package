namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLTrainSession_MLBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : MLTrainSession
	{
