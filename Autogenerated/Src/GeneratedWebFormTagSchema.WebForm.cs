namespace Terrasoft.Configuration
{
	...
	public class GeneratedWebFormTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateGeneratedWebFormTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateGeneratedWebFormTagEventsProcessSchema() {
			var schema = new GeneratedWebFormTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: GeneratedWebFormTagEventsProcessSchema

	/// <exclude/>
	public class GeneratedWebFormTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public GeneratedWebFormTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public GeneratedWebFormTagEventsProcessSchema(GeneratedWebFormTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "GeneratedWebFormTag_WebFormEventsProcess";
			UId = new Guid("f3d28fde-40b5-45f1-8d7e-b253a4873aa5");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new GeneratedWebFormTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f3d28fde-40b5-45f1-8d7e-b253a4873aa5"));
		}
