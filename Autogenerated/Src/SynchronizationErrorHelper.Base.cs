namespace Terrasoft.Configuration
{
	...
	public class SynchronizationErrorHelper : ISynchronizationErrorHelper
	{
		...
		private void UpdateErrorCode(Entity mailbox) {
			...
			var senderEmailAddress = mailbox.GetTypedColumnValue<string>("SenderEmailAddress");
			var synchronizationStopped = mailbox.GetTypedColumnValue<bool>("SynchronizationStopped");
			...
			Update update = new Update(UserConnection, mailbox.SchemaName)
							...
							.Set("SynchronizationStopped", Column.Parameter(synchronizationStopped))
