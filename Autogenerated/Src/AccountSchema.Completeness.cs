namespace Terrasoft.Configuration
{
	...
	public class Account_Completeness_TerrasoftSchema : Terrasoft.Configuration.Account_EmailMining_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccount_Completeness_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccount_Completeness_TerrasoftEventsProcessSchema() {
			var schema = new Account_Completeness_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: Account_Completeness_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Account_Completeness_TerrasoftEventsProcessSchema : Terrasoft.Configuration.Account_EmailMining_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public Account_Completeness_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Account_Completeness_TerrasoftEventsProcessSchema(Account_Completeness_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Account_CompletenessEventsProcess";
			UId = new Guid("1353b2d3-28b7-49b5-a096-2a90a491da2a");
			CreatedInPackageId = new Guid("c7634d9a-901d-4a66-9f11-34c80c5250ce");
		...
		public override object Clone() {
			return new Account_Completeness_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("1353b2d3-28b7-49b5-a096-2a90a491da2a"));
		}
