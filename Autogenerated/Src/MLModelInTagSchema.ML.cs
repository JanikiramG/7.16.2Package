namespace Terrasoft.Configuration
{
	...
	public class MLModelInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateMLModelInTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateMLModelInTagEventsProcessSchema() {
			var schema = new MLModelInTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: MLModelInTagEventsProcessSchema

	/// <exclude/>
	public class MLModelInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public MLModelInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public MLModelInTagEventsProcessSchema(MLModelInTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "MLModelInTag_MLEventsProcess";
			UId = new Guid("86bf1f76-0992-43c8-9079-3dd77343a14a");
			CreatedInPackageId = new Guid("33c09d4f-db5e-4d77-bac6-f1fd801beedb");
		...
		public override object Clone() {
			return new MLModelInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("86bf1f76-0992-43c8-9079-3dd77343a14a"));
		}
