namespace Terrasoft.Configuration
{
	...
	public class SysModuleSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysModuleEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSysModuleEventsProcessSchema() {
			var schema = new SysModuleEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class SysModule_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysModule
	{
	...
	#region Class: SysModuleEventsProcessSchema

	/// <exclude/>
	public class SysModuleEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public SysModuleEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SysModuleEventsProcessSchema(SysModuleEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysModule_BaseEventsProcess";
			UId = new Guid("6354ca33-6744-4539-b8e4-1f2c97d4dad5");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new SysModuleEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("6354ca33-6744-4539-b8e4-1f2c97d4dad5"));
		}
