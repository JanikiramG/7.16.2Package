namespace Terrasoft.Configuration
{
	...
	public class CountrySchema : Terrasoft.Configuration.Country_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCountryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCountryEventsProcessSchema() {
			var schema = new CountryEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CountryEventsProcessSchema

	/// <exclude/>
	public class CountryEventsProcessSchema : Terrasoft.Configuration.Country_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public CountryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CountryEventsProcessSchema(CountryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Country_SSPEventsProcess";
			UId = new Guid("848fe5a8-96ce-46dc-8883-b1261f763ffe");
			CreatedInPackageId = new Guid("10676561-1f93-46bf-90be-fe5cd67025e0");
			...
			ParentSchemaUId = new Guid("7c7ea1bb-afd0-4cda-90ca-6aea9309cd24");
		...
		public override object Clone() {
			return new CountryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("848fe5a8-96ce-46dc-8883-b1261f763ffe"));
		}
