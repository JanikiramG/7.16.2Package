namespace Terrasoft.Configuration
{
	...
	public class GeneratedWebFormSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateGeneratedWebFormEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateGeneratedWebFormEventsProcessSchema() {
			var schema = new GeneratedWebFormEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class GeneratedWebForm_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : GeneratedWebForm
	{
	...
	#region Class: GeneratedWebFormEventsProcessSchema

	/// <exclude/>
	public class GeneratedWebFormEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public GeneratedWebFormEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public GeneratedWebFormEventsProcessSchema(GeneratedWebFormEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "GeneratedWebForm_WebFormEventsProcess";
			UId = new Guid("0141290d-358f-4105-aad3-ae4958f8ddb6");
			CreatedInPackageId = new Guid("a350b119-a1d4-416a-b96f-a65dc67beca4");
		...
		public override object Clone() {
			return new GeneratedWebFormEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0141290d-358f-4105-aad3-ae4958f8ddb6"));
		}
