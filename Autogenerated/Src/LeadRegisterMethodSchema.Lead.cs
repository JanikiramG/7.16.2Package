namespace Terrasoft.Configuration
{
	...
	public class LeadRegisterMethodSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateLeadRegisterMethodEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateLeadRegisterMethodEventsProcessSchema() {
			var schema = new LeadRegisterMethodEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: LeadRegisterMethodEventsProcessSchema

	/// <exclude/>
	public class LeadRegisterMethodEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public LeadRegisterMethodEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public LeadRegisterMethodEventsProcessSchema(LeadRegisterMethodEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "LeadRegisterMethod_LeadEventsProcess";
			UId = new Guid("ba060974-4e51-4551-9ffc-d59e6478f311");
			CreatedInPackageId = new Guid("2f566863-6a05-41ae-bb68-b647818b8f61");
		...
		public override object Clone() {
			return new LeadRegisterMethodEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("ba060974-4e51-4551-9ffc-d59e6478f311"));
		}
