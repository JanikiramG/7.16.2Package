namespace Terrasoft.Configuration
{
	...
	public class ProductInLeadTypeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductInLeadTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateProductInLeadTypeEventsProcessSchema() {
			var schema = new ProductInLeadTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class ProductInLeadType_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ProductInLeadType
	{
	...
	#region Class: ProductInLeadTypeEventsProcessSchema

	/// <exclude/>
	public class ProductInLeadTypeEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public ProductInLeadTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ProductInLeadTypeEventsProcessSchema(ProductInLeadTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductInLeadType_LeadEventsProcess";
			UId = new Guid("357b0e3e-08c8-49a6-b2a1-276202927dd0");
			CreatedInPackageId = new Guid("f56ba749-b4df-4ded-b740-db30fa3555ae");
		...
		public override object Clone() {
			return new ProductInLeadTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("357b0e3e-08c8-49a6-b2a1-276202927dd0"));
		}
