namespace Terrasoft.Configuration
{
	...
	public class UnitForCalculationSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateUnitForCalculationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateUnitForCalculationEventsProcessSchema() {
			var schema = new UnitForCalculationEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: UnitForCalculationEventsProcessSchema

	/// <exclude/>
	public class UnitForCalculationEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public UnitForCalculationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public UnitForCalculationEventsProcessSchema(UnitForCalculationEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "UnitForCalculation_BaseEventsProcess";
			UId = new Guid("b0b6c608-228c-4cfa-bad9-132569078185");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new UnitForCalculationEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b0b6c608-228c-4cfa-bad9-132569078185"));
		}
