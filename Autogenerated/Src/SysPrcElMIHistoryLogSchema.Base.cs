namespace Terrasoft.Configuration
{
	...
	public class SysPrcElMIHistoryLogSchema : Terrasoft.Configuration.SysPrcElMILogSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSysPrcElMIHistoryLogEventsProcessSchema();
		}
	...
	#region Class: SysPrcElMIHistoryLogEventsProcessSchema

	/// <exclude/>
	public class SysPrcElMIHistoryLogEventsProcessSchema : Terrasoft.Configuration.SysPrcElMILogEventsProcessSchema
	{

		#region Constructors: Public

		public SysPrcElMIHistoryLogEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SysPrcElMIHistoryLog_BaseEventsProcess";
			UId = new Guid("2aa12c90-3589-4145-a233-b3edf7a5741a");
			CreatedInPackageId = new Guid("3c624d29-361c-47f2-ac8f-7824eb3cde6f");
			...
			ParentSchemaUId = new Guid("7a6b384d-9b28-4cf4-8165-b82b329d80a6");
		...
		public override object Clone() {
			return new SysPrcElMIHistoryLogEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2aa12c90-3589-4145-a233-b3edf7a5741a"));
		}
