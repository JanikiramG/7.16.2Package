namespace Terrasoft.Configuration
{
	...
	public class OpportunityType_Opportunity_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityType_Opportunity_TerrasoftEventsProcessSchema();
		}
	...
	#region Class: OpportunityType_Opportunity_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class OpportunityType_Opportunity_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityType_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityType_OpportunityEventsProcess";
			UId = new Guid("7e635ed9-54fb-4008-b6d6-eb763434161c");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new OpportunityType_Opportunity_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7e635ed9-54fb-4008-b6d6-eb763434161c"));
		}
