namespace Terrasoft.Configuration
{
	...
	public class ContractStateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateContractStateEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateContractStateEventsProcessSchema() {
			var schema = new ContractStateEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ContractStateEventsProcessSchema

	/// <exclude/>
	public class ContractStateEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ContractStateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ContractStateEventsProcessSchema(ContractStateEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContractState_CoreContractsEventsProcess";
			UId = new Guid("0717af86-9764-4839-9959-28a5ec96549b");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ContractStateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0717af86-9764-4839-9959-28a5ec96549b"));
		}
