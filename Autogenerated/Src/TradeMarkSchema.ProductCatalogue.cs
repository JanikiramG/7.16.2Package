namespace Terrasoft.Configuration
{
	...
	public class TradeMarkSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateTradeMarkEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateTradeMarkEventsProcessSchema() {
			var schema = new TradeMarkEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: TradeMarkEventsProcessSchema

	/// <exclude/>
	public class TradeMarkEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public TradeMarkEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public TradeMarkEventsProcessSchema(TradeMarkEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "TradeMark_ProductCatalogueEventsProcess";
			UId = new Guid("eef944d9-1516-4d7b-b1fb-9751710b0cb0");
			CreatedInPackageId = new Guid("d4cfcde0-bd2a-4719-a4df-63ed38689467");
		...
		public override object Clone() {
			return new TradeMarkEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("eef944d9-1516-4d7b-b1fb-9751710b0cb0"));
		}
