namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AttributeValue_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : AttributeValue
	{
