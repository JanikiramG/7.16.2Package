namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwContactRelationship_NUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : VwContactRelationship
	{
