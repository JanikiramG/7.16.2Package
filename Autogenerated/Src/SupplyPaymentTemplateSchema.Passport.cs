namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentTemplateSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentTemplateEventsProcessSchema();
		}
	...
	#region Class: SupplyPaymentTemplateEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentTemplateEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentTemplateEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SupplyPaymentTemplate_PassportEventsProcess";
			UId = new Guid("e534d9d7-ef6a-4a52-917c-efda177c485a");
			CreatedInPackageId = new Guid("95c2c84b-bfbc-40cb-9e93-5fad29a6591d");
		...
		public override object Clone() {
			return new SupplyPaymentTemplateEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e534d9d7-ef6a-4a52-917c-efda177c485a"));
		}
