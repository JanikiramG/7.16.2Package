namespace Terrasoft.Configuration
{
	...
	public class VwSysLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateVwSysLookupEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateVwSysLookupEventsProcessSchema() {
			var schema = new VwSysLookupEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: VwSysLookupEventsProcessSchema

	/// <exclude/>
	public class VwSysLookupEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public VwSysLookupEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public VwSysLookupEventsProcessSchema(VwSysLookupEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "VwSysLookup_BaseEventsProcess";
			UId = new Guid("90a0a160-fcb6-4e81-b757-91e622ad715a");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new VwSysLookupEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("90a0a160-fcb6-4e81-b757-91e622ad715a"));
		}
