namespace Terrasoft.Configuration
{
	...
	public class FileFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateFileFolderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateFileFolderEventsProcessSchema() {
			var schema = new FileFolderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: FileFolderEventsProcessSchema

	/// <exclude/>
	public class FileFolderEventsProcessSchema : Terrasoft.Configuration.BaseFolderEventsProcessSchema
	{

		#region Constructors: Public

		public FileFolderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public FileFolderEventsProcessSchema(FileFolderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "FileFolder_BaseEventsProcess";
			UId = new Guid("305b7ff2-6177-4c20-8d8a-ca4a5c387c6d");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new FileFolderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("305b7ff2-6177-4c20-8d8a-ca4a5c387c6d"));
		}
