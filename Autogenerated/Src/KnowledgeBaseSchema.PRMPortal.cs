namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class KnowledgeBaseSchema : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBase_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateKnowledgeBaseEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateKnowledgeBaseEventsProcessSchema() {
			var schema = new KnowledgeBaseEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// </summary>
	public class KnowledgeBase : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class KnowledgeBase_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBaseEventsProcess<TEntity> where TEntity : KnowledgeBase
	{
	...
	#region Class: KnowledgeBaseEventsProcessSchema

	/// <exclude/>
	public class KnowledgeBaseEventsProcessSchema : Terrasoft.Configuration.KnowledgeBase_SspKnowledgeBase_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public KnowledgeBaseEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public KnowledgeBaseEventsProcessSchema(KnowledgeBaseEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "KnowledgeBase_PRMPortalEventsProcess";
			UId = new Guid("1a2db284-83fe-497c-a4aa-0f2e7c3ae78b");
			CreatedInPackageId = new Guid("ba438a7b-1c87-4703-9a24-35e026996df4");
			...
			ParentSchemaUId = new Guid("ccbb59eb-ba04-45d1-8fc7-8ea68fdb61b6");
		...
		public override object Clone() {
			return new KnowledgeBaseEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("1a2db284-83fe-497c-a4aa-0f2e7c3ae78b"));
		}
