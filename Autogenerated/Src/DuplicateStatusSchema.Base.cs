namespace Terrasoft.Configuration
{
	...
	public class DuplicateStatusSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDuplicateStatusEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDuplicateStatusEventsProcessSchema() {
			var schema = new DuplicateStatusEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DuplicateStatusEventsProcessSchema

	/// <exclude/>
	public class DuplicateStatusEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DuplicateStatusEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DuplicateStatusEventsProcessSchema(DuplicateStatusEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DuplicateStatus_BaseEventsProcess";
			UId = new Guid("3ad22a9a-4362-42c5-9ae2-0760ebc7ac88");
		...
		public override object Clone() {
			return new DuplicateStatusEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3ad22a9a-4362-42c5-9ae2-0760ebc7ac88"));
		}
