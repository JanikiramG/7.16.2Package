namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysLocalizableValue_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SysLocalizableValue
	{
