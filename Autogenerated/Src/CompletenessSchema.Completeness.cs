namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Completeness_CompletenessEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : Completeness
	{
