namespace Terrasoft.Configuration
{
	...
	public class GenderSchema : Terrasoft.Configuration.Gender_Base_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateGenderEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateGenderEventsProcessSchema() {
			var schema = new GenderEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: GenderEventsProcessSchema

	/// <exclude/>
	public class GenderEventsProcessSchema : Terrasoft.Configuration.Gender_Base_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public GenderEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public GenderEventsProcessSchema(GenderEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Gender_SSPEventsProcess";
			UId = new Guid("07cb1035-b291-461c-a7ad-5a1bafb434a5");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
			...
			ParentSchemaUId = new Guid("b7e597e8-d428-4a4d-8319-9dc14978d900");
		...
		public override object Clone() {
			return new GenderEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("07cb1035-b291-461c-a7ad-5a1bafb434a5"));
		}
