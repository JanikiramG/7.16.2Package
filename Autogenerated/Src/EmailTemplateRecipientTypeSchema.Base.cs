namespace Terrasoft.Configuration
{
	...
	public class EmailTemplateRecipientTypeSchema : Terrasoft.Configuration.SysCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEmailTemplateRecipientTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEmailTemplateRecipientTypeEventsProcessSchema() {
			var schema = new EmailTemplateRecipientTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EmailTemplateRecipientTypeEventsProcessSchema

	/// <exclude/>
	public class EmailTemplateRecipientTypeEventsProcessSchema : Terrasoft.Configuration.SysCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EmailTemplateRecipientTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EmailTemplateRecipientTypeEventsProcessSchema(EmailTemplateRecipientTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EmailTemplateRecipientType_BaseEventsProcess";
			UId = new Guid("da467718-f7ef-4055-8771-e52c3949fb4d");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new EmailTemplateRecipientTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("da467718-f7ef-4055-8771-e52c3949fb4d"));
		}
