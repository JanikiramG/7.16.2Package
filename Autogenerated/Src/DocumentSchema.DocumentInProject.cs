namespace Terrasoft.Configuration
{
	...
	public class DocumentSchema : Terrasoft.Configuration.Document_DocumentInContract_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDocumentEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDocumentEventsProcessSchema() {
			var schema = new DocumentEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DocumentEventsProcessSchema

	/// <exclude/>
	public class DocumentEventsProcessSchema : Terrasoft.Configuration.Document_DocumentInContract_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public DocumentEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DocumentEventsProcessSchema(DocumentEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Document_DocumentInProjectEventsProcess";
			UId = new Guid("9346b993-0bcd-4383-97d0-703464e7a46c");
			CreatedInPackageId = new Guid("fe2bb0e4-061e-41b1-be85-5078c802043f");
		...
		public override object Clone() {
			return new DocumentEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9346b993-0bcd-4383-97d0-703464e7a46c"));
		}
