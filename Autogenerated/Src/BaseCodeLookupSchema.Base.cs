namespace Terrasoft.Configuration
{
	...
	public class BaseCodeLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateBaseCodeLookupEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateBaseCodeLookupEventsProcessSchema() {
			var schema = new BaseCodeLookupEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: BaseCodeLookupEventsProcessSchema

	/// <exclude/>
	public class BaseCodeLookupEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public BaseCodeLookupEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public BaseCodeLookupEventsProcessSchema(BaseCodeLookupEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new BaseCodeLookupEventsProcessSchema(this);
		}
