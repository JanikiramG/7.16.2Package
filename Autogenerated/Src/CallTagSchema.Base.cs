namespace Terrasoft.Configuration
{
	...
	public class CallTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateCallTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateCallTagEventsProcessSchema() {
			var schema = new CallTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: CallTagEventsProcessSchema

	/// <exclude/>
	public class CallTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public CallTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public CallTagEventsProcessSchema(CallTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "CallTag_BaseEventsProcess";
			UId = new Guid("2f807309-5313-45d6-be93-74f0ebdce59b");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new CallTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2f807309-5313-45d6-be93-74f0ebdce59b"));
		}
