namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentDelaySchema : Terrasoft.Configuration.SupplyPaymentDelay_Passport_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentDelayEventsProcessSchema();
		}
	...
	#region Class: SupplyPaymentDelayEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentDelayEventsProcessSchema : Terrasoft.Configuration.SupplyPaymentDelay_Passport_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentDelayEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SupplyPaymentDelay_PRMOrderEventsProcess";
			UId = new Guid("77092078-ed97-4bb5-b68c-bce65e3c7d9f");
			CreatedInPackageId = new Guid("f50b1877-37f3-4844-90b8-f493542cdd8d");
		...
		public override object Clone() {
			return new SupplyPaymentDelayEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("77092078-ed97-4bb5-b68c-bce65e3c7d9f"));
		}
