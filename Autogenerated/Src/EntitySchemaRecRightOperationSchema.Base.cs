namespace Terrasoft.Configuration
{
	...
	public class EntitySchemaRecRightOperationSchema : Terrasoft.Configuration.BaseValueLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEntitySchemaRecRightOperationEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEntitySchemaRecRightOperationEventsProcessSchema() {
			var schema = new EntitySchemaRecRightOperationEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: EntitySchemaRecRightOperationEventsProcessSchema

	/// <exclude/>
	public class EntitySchemaRecRightOperationEventsProcessSchema : Terrasoft.Configuration.BaseValueLookupEventsProcessSchema
	{

		#region Constructors: Public

		public EntitySchemaRecRightOperationEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EntitySchemaRecRightOperationEventsProcessSchema(EntitySchemaRecRightOperationEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EntitySchemaRecRightOperation_BaseEventsProcess";
			UId = new Guid("7c13556d-5a4a-4e6c-9b26-444ece7efeeb");
		...
		public override object Clone() {
			return new EntitySchemaRecRightOperationEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7c13556d-5a4a-4e6c-9b26-444ece7efeeb"));
		}
