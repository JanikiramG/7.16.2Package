namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_Lead_TerrasoftSchema : Terrasoft.Configuration.Activity_SSP_TerrasoftSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivity_Lead_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivity_Lead_TerrasoftEventsProcessSchema() {
			var schema = new Activity_Lead_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// Activity.
	/// </summary>
	public class Activity_Lead_Terrasoft : Terrasoft.Configuration.Activity_SSP_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_LeadEventsProcess<TEntity> : Terrasoft.Configuration.Activity_SSPEventsProcess<TEntity> where TEntity : Activity_Lead_Terrasoft
	{
	...
	#region Class: Activity_Lead_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Activity_Lead_TerrasoftEventsProcessSchema : Terrasoft.Configuration.Activity_SSP_TerrasoftEventsProcessSchema
	{

		#region Constructors: Public

		public Activity_Lead_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Activity_Lead_TerrasoftEventsProcessSchema(Activity_Lead_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Activity_LeadEventsProcess";
			UId = new Guid("1e6b597a-7314-4042-bb1d-ab0ec5a9b9fd");
			CreatedInPackageId = new Guid("9673128b-9de8-44a3-831c-e9da860e995c");
		...
		public override object Clone() {
			return new Activity_Lead_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("1e6b597a-7314-4042-bb1d-ab0ec5a9b9fd"));
		}
