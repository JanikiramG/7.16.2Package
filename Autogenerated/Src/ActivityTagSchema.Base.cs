namespace Terrasoft.Configuration
{
	...
	public class ActivityTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivityTagEventsProcessSchema();
		}
	...
	#region Class: ActivityTagEventsProcessSchema

	/// <exclude/>
	public class ActivityTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public ActivityTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ActivityTag_BaseEventsProcess";
			UId = new Guid("e498e97a-0d3c-4d2e-9186-fa91c4bfd3b7");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ActivityTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e498e97a-0d3c-4d2e-9186-fa91c4bfd3b7"));
		}
