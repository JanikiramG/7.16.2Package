namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductUnit_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ProductUnit_ProductCatalogue_Terrasoft
	{
