namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EnrchEmailData_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : EnrchEmailData
	{
