namespace Terrasoft.Configuration
{
	...
	public class DepartmentSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDepartmentEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDepartmentEventsProcessSchema() {
			var schema = new DepartmentEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DepartmentEventsProcessSchema

	/// <exclude/>
	public class DepartmentEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DepartmentEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DepartmentEventsProcessSchema(DepartmentEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Department_BaseEventsProcess";
			UId = new Guid("a793b8b3-bd79-4a0b-901b-dd05fc942064");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new DepartmentEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("a793b8b3-bd79-4a0b-901b-dd05fc942064"));
		}
