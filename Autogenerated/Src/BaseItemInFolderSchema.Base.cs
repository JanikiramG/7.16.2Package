namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseItemInFolder_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : BaseItemInFolder
	{
