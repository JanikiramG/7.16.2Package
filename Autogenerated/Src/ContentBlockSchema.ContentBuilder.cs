namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContentBlock_ContentBuilderEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ContentBlock
	{
