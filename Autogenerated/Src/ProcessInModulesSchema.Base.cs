namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProcessInModules_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ProcessInModules_Base_Terrasoft
	{
