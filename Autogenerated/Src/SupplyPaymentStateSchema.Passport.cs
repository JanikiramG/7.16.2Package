namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentState_Passport_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentState_Passport_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSupplyPaymentState_Passport_TerrasoftEventsProcessSchema() {
			var schema = new SupplyPaymentState_Passport_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SupplyPaymentState_Passport_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentState_Passport_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentState_Passport_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SupplyPaymentState_Passport_TerrasoftEventsProcessSchema(SupplyPaymentState_Passport_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "SupplyPaymentState_PassportEventsProcess";
			UId = new Guid("537c0d45-1d90-4e34-ae49-59f00e4af35c");
			CreatedInPackageId = new Guid("f50b1877-37f3-4844-90b8-f493542cdd8d");
		...
		public override object Clone() {
			return new SupplyPaymentState_Passport_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("537c0d45-1d90-4e34-ae49-59f00e4af35c"));
		}
