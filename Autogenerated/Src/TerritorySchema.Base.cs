namespace Terrasoft.Configuration
{
	...
	public class TerritorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateTerritoryEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateTerritoryEventsProcessSchema() {
			var schema = new TerritoryEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: TerritoryEventsProcessSchema

	/// <exclude/>
	public class TerritoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public TerritoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public TerritoryEventsProcessSchema(TerritoryEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "Territory_BaseEventsProcess";
			UId = new Guid("e384ae76-d5ce-4b9c-bca2-40dd6760539a");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new TerritoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("e384ae76-d5ce-4b9c-bca2-40dd6760539a"));
		}
