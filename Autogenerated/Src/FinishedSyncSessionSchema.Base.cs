namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FinishedSyncSession_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : FinishedSyncSession
	{
