namespace Terrasoft.Configuration
{
	...
	public class AccountCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountCategoryEventsProcessSchema();
		}
	...
	#region Class: AccountCategoryEventsProcessSchema

	/// <exclude/>
	public class AccountCategoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public AccountCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountCategory_BaseEventsProcess";
			UId = new Guid("8d8fc988-b63e-4b1b-b701-e8898ff35c42");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new AccountCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8d8fc988-b63e-4b1b-b701-e8898ff35c42"));
		}
