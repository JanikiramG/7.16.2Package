namespace Terrasoft.Configuration
{
	...
	public class TimeZoneSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateTimeZoneEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateTimeZoneEventsProcessSchema() {
			var schema = new TimeZoneEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: TimeZoneEventsProcessSchema

	/// <exclude/>
	public class TimeZoneEventsProcessSchema : Terrasoft.Configuration.BaseCodeLookupEventsProcessSchema
	{

		#region Constructors: Public

		public TimeZoneEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public TimeZoneEventsProcessSchema(TimeZoneEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "TimeZone_BaseEventsProcess";
			UId = new Guid("eb58693d-f3b0-4873-b185-174f14e8b63e");
		...
		public override object Clone() {
			return new TimeZoneEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("eb58693d-f3b0-4873-b185-174f14e8b63e"));
		}
