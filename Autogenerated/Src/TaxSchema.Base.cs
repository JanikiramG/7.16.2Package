namespace Terrasoft.Configuration
{
	...
	public class Tax_Base_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateTax_Base_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateTax_Base_TerrasoftEventsProcessSchema() {
			var schema = new Tax_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: Tax_Base_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class Tax_Base_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public Tax_Base_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public Tax_Base_TerrasoftEventsProcessSchema(Tax_Base_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new Tax_Base_TerrasoftEventsProcessSchema(this);
		}
