namespace Terrasoft.Configuration
{
	...
	public class AccountTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateAccountTagEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateAccountTagEventsProcessSchema() {
			var schema = new AccountTagEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: AccountTagEventsProcessSchema

	/// <exclude/>
	public class AccountTagEventsProcessSchema : Terrasoft.Configuration.BaseTagEventsProcessSchema
	{

		#region Constructors: Public

		public AccountTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public AccountTagEventsProcessSchema(AccountTagEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "AccountTag_BaseEventsProcess";
			UId = new Guid("b425038e-4f27-46dc-9b37-124d5f063100");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new AccountTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("b425038e-4f27-46dc-9b37-124d5f063100"));
		}
