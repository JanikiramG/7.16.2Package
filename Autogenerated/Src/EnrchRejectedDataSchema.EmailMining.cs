namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EnrchRejectedData_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : EnrchRejectedData
	{
