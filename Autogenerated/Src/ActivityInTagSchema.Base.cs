namespace Terrasoft.Configuration
{
	...
	public class ActivityInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivityInTagEventsProcessSchema();
		}
	...
	#region Class: ActivityInTagEventsProcessSchema

	/// <exclude/>
	public class ActivityInTagEventsProcessSchema : Terrasoft.Configuration.BaseEntityInTagEventsProcessSchema
	{

		#region Constructors: Public

		public ActivityInTagEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ActivityInTag_BaseEventsProcess";
			UId = new Guid("1924749f-34d6-4ff7-b915-f235098fb61c");
			CreatedInPackageId = new Guid("9e68a40f-2533-42d0-8fe0-88fdb6bf5704");
		...
		public override object Clone() {
			return new ActivityInTagEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("1924749f-34d6-4ff7-b915-f235098fb61c"));
		}
