namespace Terrasoft.Configuration
{
	...
	public class DocumentTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateDocumentTypeEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateDocumentTypeEventsProcessSchema() {
			var schema = new DocumentTypeEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: DocumentTypeEventsProcessSchema

	/// <exclude/>
	public class DocumentTypeEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public DocumentTypeEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public DocumentTypeEventsProcessSchema(DocumentTypeEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "DocumentType_DocumentEventsProcess";
			UId = new Guid("5811a2ca-6c18-4639-9fab-e49fcac7f46d");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new DocumentTypeEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("5811a2ca-6c18-4639-9fab-e49fcac7f46d"));
		}
