namespace Terrasoft.Configuration
{
	...
	public class ProductCategorySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateProductCategoryEventsProcessSchema();
		}
	...
	#region Class: ProductCategoryEventsProcessSchema

	/// <exclude/>
	public class ProductCategoryEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ProductCategoryEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ProductCategory_ProductCatalogueEventsProcess";
			UId = new Guid("2286fe4b-fb09-4107-bcdb-eefe440a64cc");
			CreatedInPackageId = new Guid("d4cfcde0-bd2a-4719-a4df-63ed38689467");
		...
		public override object Clone() {
			return new ProductCategoryEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("2286fe4b-fb09-4107-bcdb-eefe440a64cc"));
		}
