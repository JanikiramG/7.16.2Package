namespace Terrasoft.Configuration
{
	...
	public class ReasonForLeavingSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateReasonForLeavingEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateReasonForLeavingEventsProcessSchema() {
			var schema = new ReasonForLeavingEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ReasonForLeavingEventsProcessSchema

	/// <exclude/>
	public class ReasonForLeavingEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public ReasonForLeavingEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ReasonForLeavingEventsProcessSchema(ReasonForLeavingEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ReasonForLeaving_BaseEventsProcess";
			UId = new Guid("7b8edb28-496b-491f-a0f7-de02a3c1b1e1");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ReasonForLeavingEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("7b8edb28-496b-491f-a0f7-de02a3c1b1e1"));
		}
