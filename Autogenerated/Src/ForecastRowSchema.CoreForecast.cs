namespace Terrasoft.Configuration
{
	...
	public class ForecastRowSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateForecastRowEventsProcessSchema();
		}
	...
	/// <exclude/>
	public partial class ForecastRow_CoreForecastEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : ForecastRow
	{
	...
	#region Class: ForecastRowEventsProcessSchema

	/// <exclude/>
	public class ForecastRowEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public ForecastRowEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ForecastRow_CoreForecastEventsProcess";
			UId = new Guid("8ad27347-8b21-450b-aea7-83b01c5afdd1");
			CreatedInPackageId = new Guid("e0b9d996-6f7e-4520-a678-da960c79be39");
		...
		public override object Clone() {
			return new ForecastRowEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("8ad27347-8b21-450b-aea7-83b01c5afdd1"));
		}
