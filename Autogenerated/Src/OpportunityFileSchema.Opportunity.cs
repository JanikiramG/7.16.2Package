namespace Terrasoft.Configuration
{
	...
	public class OpportunityFile_Opportunity_TerrasoftSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateOpportunityFile_Opportunity_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateOpportunityFile_Opportunity_TerrasoftEventsProcessSchema() {
			var schema = new OpportunityFile_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: OpportunityFile_Opportunity_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class OpportunityFile_Opportunity_TerrasoftEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public OpportunityFile_Opportunity_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public OpportunityFile_Opportunity_TerrasoftEventsProcessSchema(OpportunityFile_Opportunity_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "OpportunityFile_OpportunityEventsProcess";
			UId = new Guid("3dabaf7f-1ed2-4ce4-9d02-f8a1291565f7");
			CreatedInPackageId = new Guid("8a6b5719-da97-4634-8f04-4375bc29ffcf");
		...
		public override object Clone() {
			return new OpportunityFile_Opportunity_TerrasoftEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("3dabaf7f-1ed2-4ce4-9d02-f8a1291565f7"));
		}
