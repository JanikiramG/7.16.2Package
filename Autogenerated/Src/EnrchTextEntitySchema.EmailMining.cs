namespace Terrasoft.Configuration
{
	...
	public class EnrchTextEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateEnrchTextEntityEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateEnrchTextEntityEventsProcessSchema() {
			var schema = new EnrchTextEntityEventsProcessSchema(ProcessSchemaManager, this);
	...
	/// <exclude/>
	public partial class EnrchTextEntity_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : EnrchTextEntity
	{
	...
	#region Class: EnrchTextEntityEventsProcessSchema

	/// <exclude/>
	public class EnrchTextEntityEventsProcessSchema : Terrasoft.Configuration.BaseEntityEventsProcessSchema
	{

		#region Constructors: Public

		public EnrchTextEntityEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public EnrchTextEntityEventsProcessSchema(EnrchTextEntityEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "EnrchTextEntity_EmailMiningEventsProcess";
			UId = new Guid("50185d30-eff4-47c1-9d26-a94495f2bf3b");
			CreatedInPackageId = new Guid("c1529436-dee9-4290-84f1-87386440a2b1");
		...
		public override object Clone() {
			return new EnrchTextEntityEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("50185d30-eff4-47c1-9d26-a94495f2bf3b"));
		}
