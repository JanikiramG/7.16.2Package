namespace Terrasoft.Configuration
{
	...
	public class SupplyPaymentType_Passport_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateSupplyPaymentType_Passport_TerrasoftEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateSupplyPaymentType_Passport_TerrasoftEventsProcessSchema() {
			var schema = new SupplyPaymentType_Passport_TerrasoftEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: SupplyPaymentType_Passport_TerrasoftEventsProcessSchema

	/// <exclude/>
	public class SupplyPaymentType_Passport_TerrasoftEventsProcessSchema : Terrasoft.Configuration.BaseLookupEventsProcessSchema
	{

		#region Constructors: Public

		public SupplyPaymentType_Passport_TerrasoftEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public SupplyPaymentType_Passport_TerrasoftEventsProcessSchema(SupplyPaymentType_Passport_TerrasoftEventsProcessSchema source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new SupplyPaymentType_Passport_TerrasoftEventsProcessSchema(this);
		}
