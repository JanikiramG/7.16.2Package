namespace Terrasoft.Configuration
{
	...
	public class ActivityFileSchema : Terrasoft.Configuration.FileSchema
	{
		...
		protected override void InitializeEventsProcessSchema() {
			EventsProcessSchema = CreateActivityFileEventsProcessSchema();
		}

		protected virtual ProcessSchema CreateActivityFileEventsProcessSchema() {
			var schema = new ActivityFileEventsProcessSchema(ProcessSchemaManager, this);
	...
	#region Class: ActivityFileEventsProcessSchema

	/// <exclude/>
	public class ActivityFileEventsProcessSchema : Terrasoft.Configuration.FileEventsProcessSchema
	{

		#region Constructors: Public

		public ActivityFileEventsProcessSchema(ProcessSchemaManager processSchemaManager, ProcessBasedSchema ownerSchema)
			: base(processSchemaManager, ownerSchema) {
		}

		public ActivityFileEventsProcessSchema(ActivityFileEventsProcessSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ActivityFile_BaseEventsProcess";
			UId = new Guid("255dd47c-96cd-4115-9683-187cd6328d08");
			CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6");
		...
		public override object Clone() {
			return new ActivityFileEventsProcessSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("255dd47c-96cd-4115-9683-187cd6328d08"));
		}
