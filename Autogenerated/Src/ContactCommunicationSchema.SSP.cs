namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactCommunicationSchema : Terrasoft.Configuration.ContactCommunication_Base_TerrasoftSchema
	{
	...
	/// </summary>
	public class ContactCommunication : Terrasoft.Configuration.ContactCommunication_Base_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ContactCommunication_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactCommunication_BaseEventsProcess<TEntity> where TEntity : ContactCommunication
	{
	...
	/// <exclude/>
	public class ContactCommunication_SSPEventsProcess : ContactCommunication_SSPEventsProcess<ContactCommunication>
	{
	...
	/// <exclude/>
	public class ContactCommunicationEventsProcessSchema : Terrasoft.Configuration.ContactCommunication_Base_TerrasoftEventsProcessSchema
	{
		...
		protected override void InitializeProperties() {
			base.InitializeProperties();
			Name = "ContactCommunication_SSPEventsProcess";
			UId = new Guid("11a7d27a-f3dc-4e85-a706-d1aaa4581960");
			CreatedInPackageId = new Guid("d7352345-17a4-46e8-b32e-306ac0453d7a");
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("11a7d27a-f3dc-4e85-a706-d1aaa4581960"));
		}
	...
	/// <exclude/>
	public class ContactCommunicationEventsProcess : ContactCommunication_SSPEventsProcess
	{
