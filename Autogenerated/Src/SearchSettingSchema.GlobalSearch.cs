namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SearchSetting_GlobalSearchEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : SearchSetting
	{
