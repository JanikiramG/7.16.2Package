namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseEntityInStage_BaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_BaseEventsProcess<TEntity> where TEntity : BaseEntityInStage
	{
